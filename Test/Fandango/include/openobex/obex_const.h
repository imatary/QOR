...
enum obex_hdr_type 
{
	OBEX_HDR_TYPE_INVALID = -1,								/** used as invalid return value */
	OBEX_HDR_TYPE_UNICODE = (0 << OBEX_HDR_TYPE_SHIFT),		/** zero terminated unicode string (network byte order) */
	OBEX_HDR_TYPE_BYTES   = (1 << OBEX_HDR_TYPE_SHIFT),		/** byte array */
	OBEX_HDR_TYPE_UINT8   = (2 << OBEX_HDR_TYPE_SHIFT),		/** 8bit unsigned integer */	
	OBEX_HDR_TYPE_UINT32  = (3 << OBEX_HDR_TYPE_SHIFT),		/** 32bit unsigned integer */
};
