...
#ifndef WINQL_IO_SOCKETSOURCE_H_3
#define WINQL_IO_SOCKETSOURCE_H_3
...
namespace nsWin32
{
	...
	//--------------------------------------------------------------------------------
	//A general Bluefoot source which reads from a Win32 Socket connection
	class __QOR_INTERFACE( __WINQL ) CSocketSource : public CIOSource
	{
	public:
		...
		virtual bool Read( unsigned long ulNumberOfUnitsToRead, unsigned long& ulNumberOfBytesRead, unsigned long ulUnitSize = 1 );
		virtual bool IsAtEnd( void );
	};

}//nsWin32

#endif//WINQL_IO_SOCKETSOURCE_H_3
