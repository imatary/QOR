...
#if !defined(QOR_VMD_ASSERT_IS_IDENTIFIER_H)
#define QOR_VMD_ASSERT_IS_IDENTIFIER_H
...
/** \def QOR_VMD_ASSERT_IS_IDENTIFIER(...)
    ...
    Identifiers are registered in VMD with:
        ...
        #define QOR_VMD_REG_XXX (XXX) where XXX is a v-identifier.
    
    The identifier must be registered to be found.
    
    Identifiers are pre-detected in VMD with:
    
        #define QOR_VMD_DETECT_XXX_XXX where XXX is an identifier.
...
/** \def QOR_VMD_ASSERT_IS_IDENTIFIER_D(d,...)
...
#define QOR_VMD_ASSERT_IS_IDENTIFIER(...)
#define QOR_VMD_ASSERT_IS_IDENTIFIER_D(d,...)
...
#define QOR_VMD_ASSERT_IS_IDENTIFIER(...) \
    QOR_VMD_ASSERT \
          ( \
          QOR_VMD_IS_IDENTIFIER(__VA_ARGS__), \
          QOR_VMD_IDENTIFIER_ASSERT_ERROR \
          ) \
/**/
...
#define QOR_VMD_ASSERT_IS_IDENTIFIER_D(d,...) \
    QOR_VMD_ASSERT \
          ( \
          QOR_VMD_IS_IDENTIFIER_D(d,__VA_ARGS__), \
          QOR_VMD_IDENTIFIER_ASSERT_ERROR \
          ) \
/**/
...
#endif /* QOR_VMD_ASSERT_IS_IDENTIFIER_H */
