...
#		define QOR_SYS_PLATFORMTYPES( _X )			__QCMP_PATHIFY4( SystemQOR,QOR_SYS_PLATFORMFOLDER,types, QOR_PP_CAT(_X,_types.h) )
#		define QOR_SYS_PLATFORMSYSTYPES( _X )		__QCMP_PATHIFY5( SystemQOR,QOR_SYS_PLATFORMFOLDER,types,sys,QOR_PP_CAT(_X,_types.h) )
#		define QOR_SYS_PLATFORMNETINETTYPES( _X )	__QCMP_PATHIFY5( SystemQOR,QOR_SYS_PLATFORMFOLDER,types,netinet,QOR_PP_CAT(_X,_types.h) )
#		define QOR_SYS_PLATFORMNETTYPES( _X )		__QCMP_PATHIFY5( SystemQOR,QOR_SYS_PLATFORMFOLDER,types,net,QOR_PP_CAT(_X,_types.h) )
#		define QOR_SYS_PLATFORMARPATYPES( _X )		__QCMP_PATHIFY5( SystemQOR,QOR_SYS_PLATFORMFOLDER,types,arpa,QOR_PP_CAT(_X,_types.h) )
