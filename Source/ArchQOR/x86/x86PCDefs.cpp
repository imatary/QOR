...
namespace nsArch
{
	...
	namespace nsx86
	{
		...
		Cmp_unsigned__int32 ConditionToInstruction::toJCC( CONDITION cc ) __QCMP_THROW
		{
			assert( static_cast< Cmp_unsigned__int32 >( cc ) <= 0xF );
			return _jcctable[ cc ];
		}

		//------------------------------------------------------------------------------
		// Translate condition code cc to cmovcc instruction code.
		Cmp_unsigned__int32 ConditionToInstruction::toCMovCC( CONDITION cc ) __QCMP_THROW
		{
			assert( static_cast< Cmp_unsigned__int32 >( cc ) <= 0xF );
		...
		Cmp_unsigned__int32 ConditionToInstruction::toSetCC( CONDITION cc ) __QCMP_THROW
		{
			assert( static_cast< Cmp_unsigned__int32 >( cc ) <= 0xF );
