...
#ifndef APPOCRITAQOR_ISUBSYSTEM_H_3
#define APPOCRITAQOR_ISUBSYSTEM_H_3
...
namespace nsQOR
{
	...
	//------------------------------------------------------------------------------
	class __QOR_INTERFACE( __APPOCRITA ) ISubSystem
	{
	public:

		__QOR_IMPL_REF( ISubSystem );
	...
	private:
		...
		ISubSystem& operator = ( const ISubSystem& );
	};

}//nsQOR

#endif//APPOCRITAQOR_ISUBSYSTEM_H_3
