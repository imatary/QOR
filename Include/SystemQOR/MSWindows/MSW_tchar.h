...
//definitions for generic international text functions
 ...
 #define _WConst_return _CONST_RETURN
     ...
     #define _tcsxfrm_l  _wcsxfrm_l
         ...
         __inline  size_t __QCMP_CALLCON _tclen( const wchar_t *_Cpc)
         {
             /* avoid compiler warning */
             (void *)_Cpc;
             return 1;
         }
         __inline void __QCMP_CALLCON _tccpy( wchar_t *_Pc1,  const wchar_t *_Cpc2) { *_Pc1 = (wchar_t)*_Cpc2; }
         __inline  int __QCMP_CALLCON _tccmp( const wchar_t *_Cpc1,  const wchar_t *_Cpc2) { return (int) ((*_Cpc1)-(*_Cpc2)); }
     ...
     #define _istleadbyte_l(_Char, _Locale)  (0)
         ...
         size_t __cdecl __wcsncnt( const wchar_t * _Str,  size_t _MaxCount );
     ...
     #else  /* __STDC__ || defined (_NO_INLINING) */
         __inline  wchar_t * __QCMP_CALLCON _wcsdec( const wchar_t * _Cpc1,  const wchar_t * _Cpc2) { return (wchar_t *)((_Cpc1)>=(_Cpc2) ? NULL : ((_Cpc2)-1)); }
         __inline  wchar_t * __QCMP_CALLCON _wcsinc( const wchar_t * _Pc) { return (wchar_t *)(_Pc+1); }
         __inline  unsigned int __QCMP_CALLCON _wcsnextc( const wchar_t * _Cpc) { return (unsigned int)*_Cpc; }
         __inline  wchar_t * __QCMP_CALLCON _wcsninc( const wchar_t * _Pc,  size_t _Sz) { return (wchar_t *)(_Pc+_Sz); }
         /*
         __inline  size_t __QCMP_CALLCON _wcsncnt( __in_ecount_z(_Cnt) const wchar_t * _String,  size_t _Cnt)
         {
                 size_t n = _Cnt;
         ...
         */
         ...
         __inline  wchar_t * __QCMP_CALLCON _wcsspnp
         (
              const wchar_t * _Cpc1,
              const wchar_t * _Cpc2
         )
         ...
         __inline wchar_t * __QCMP_CALLCON _wcsncpy_l( wchar_t *_Destination,  const wchar_t *_Source,  size_t _Count,  _locale_t _Locale)
         {
             __QCS_UNUSED( _Locale );
             #pragma warning( push )
         ...
         /*#if __STDC_WANT_SECURE_LIB__
             __inline errno_t __QCMP_CALLCON _wcsncpy_s_l(__out_ecount_z(_Destination_size_chars) wchar_t *_Destination,  size_t _Destination_size_chars,  const wchar_t *_Source,  size_t _Count,  _locale_t _Locale)
             {
                 __QCMP_UNREF(_Locale);
                 #pragma warning( push )
         ...
         //__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3(errno_t, _wcsncpy_s_l,  wchar_t, _Dest,  const wchar_t *, _Source,  size_t, _Count,  _locale_t, _Locale)
 
         __inline wchar_t * __QCMP_CALLCON _wcsncat_l( wchar_t *_Destination,  const wchar_t *_Source,  size_t _Count,  _locale_t _Locale)
         {
             __QCS_UNUSED(_Locale);
             #pragma warning( push )
         ...
         /*#if __STDC_WANT_SECURE_LIB__
             __inline __checkReturn_wat errno_t __QCMP_CALLCON _wcsncat_s_l(__inout_ecount_z(_Destination_size_chars) wchar_t *_Destination,  size_t _Destination_size_chars,  const wchar_t *_Source,  size_t _Count,  _locale_t _Locale)
             {
                 __QCMP_UNREF(_Locale);
                 #pragma warning( push )
                 #pragma warning( disable : 4996 )
         ...
         //__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3(errno_t, _wcsncat_s_l, __inout_ecount(_Size) wchar_t, _Dest,  const wchar_t *, _Source,  size_t, _Count,  _locale_t, _Locale)
         ...
         __inline wchar_t * _wcstok_l( wchar_t * _String,  const wchar_t * _Delimiters,  _locale_t _Locale)
         {
             ...
             #pragma warning(disable:4996)
             wchar_t* pwchPatch = 0;
             return wcstok(_String,_Delimiters, &pwchPatch );
             #pragma warning(pop)
         }
 /*
 ...
 */
 /*
         __inline wchar_t * __QCMP_CALLCON _wcsnset_l( wchar_t * _Destination,  wchar_t _Value,  size_t _Count,  _locale_t _Locale)
         {
             __QCMP_UNREF(_Locale);
             #pragma warning( push )
             #pragma warning( disable : 4996 )
 ...
 */
 /*
         __inline errno_t _wcsnset_s_l(__inout_ecount_z(_Destination_size_chars) wchar_t * _Destination,  size_t _Destination_size_chars,  wchar_t _Value,  size_t _Count,  _locale_t _Locale)
         {
             __QCMP_UNREF(_Locale);
 ...
 */
 /*
         __inline wchar_t * __QCMP_CALLCON _wcsset_l( wchar_t * _Destination,  wchar_t _Value,  _locale_t _Locale)
         {
             __QCMP_UNREF(_Locale);
             #pragma warning( push )
             #pragma warning( disable : 4996 )
 ...
 */
 /*
         __inline errno_t _wcsset_s_l(__inout_ecount_z(_Destination_size_chars) wchar_t * _Destination,  size_t _Destination_size_chars,  wchar_t _Value,  _locale_t _Locale)
         {
             __QCMP_UNREF(_Locale);
...
#include <string.h>
     ...
     #define _tsetlocale setlocale
         ...
         __QCMP_STARTLINKAGE_C
             ...
             #define _tccpy_s_l  _mbccpy_s_l
                 ...
                 _CRTIMP char * __cdecl _tcsncat_s(__inout_ecount(_DstSizeInChars) char *_Dst,  size_t _DstSizeInChars,  const char *_Src, size_t _MaxCount);
                 _CRTIMP char * __cdecl _tcsncat_l(  char *_Dst,  const char *_Src,  size_t _MaxCount,  _locale_t _Locale);
                 _CRTIMP char * __cdecl _tcsncat_s_l(__inout_ecount(_DstSizeInChars) char *_Dst,  size_t _DstSizeInChars,  const char *_Src,  size_t _MaxCount,  _locale_t _Locale);
                 ...
                 _CRTIMP  char * __cdecl _tcstok(__inout_opt char *_Str,  const char *_Delim);
                 _CRTIMP  char * __cdecl _tcstok_s(__inout_opt char *_Str,  const char *_Delim,  char **_Context);
                 _CRTIMP  char * __cdecl _tcstok_l(__inout_opt char *_Str,  const char *_Delim,  _locale_t _Locale);
                 _CRTIMP  char * __cdecl _tcstok_s_l(__inout_opt char *_Str,  const char *_Delim,  char **_Context,  _locale_t _Locale);
                 ...
                 _CRTIMP __checkReturn_wat errno_t __cdecl _tcsset_s(__inout_ecount_z(_SizeInChars) char * _Str,  size_t _SizeInChars,  unsigned int _Val);
                 _CRTIMP __checkReturn_wat errno_t __cdecl _tcsset_s_l(__inout_ecount_z(_SizeInChars) char * _Str,  size_t _SizeInChars,  unsigned int,  _locale_t _Locale);
                 ...
                 _CRTIMP  size_t __cdecl _tcscnlen(__in_ecount(_MaxCount) const char *_Str,  size_t _MaxCount);
                 ...
                 _CRTIMP char * __cdecl _tcsnccat(__inout char *_Dst,  const char *_Src,  size_t _MaxCount);
                 _CRTIMP char * __cdecl _tcsnccat_s(__inout_ecount(_DstSizeInChars) char *_Dst,  size_t _DstSizeInChars,  const char *_Src,  size_t _MaxCount);
                 _CRTIMP char * __cdecl _tcsnccat_l(__inout char *_Dst,  const char *_Src,  size_t _MaxCount,  _locale_t _Locale);
                 _CRTIMP char * __cdecl _tcsnccat_s_l(__inout_ecount(_DstSizeInChars) char *_Dst,  size_t _DstSizeInChars,  const char *_Src,  size_t _MaxCount,  _locale_t _Locale);
                 ...
                 _CRTIMP char * __cdecl _tcsncset(__inout_ecount_z(_MaxCount) char * _Str,  unsigned int _Val,  size_t _MaxCount);
 
                 /* MBCS-specific mappings */
 
                 _CRTIMP char * __cdecl _tcsdec(__in_ecount_z(_Pos-_Start+1) const char * _Start,  const char * _Pos);
                 _CRTIMP char * __cdecl _tcsinc( const char * _Ptr);
                 _CRTIMP size_t __cdecl _tcsnbcnt(__in_ecount_z(_MaxCount) const char * _Str,  size_t _MaxCount);
                 _CRTIMP size_t __cdecl _tcsnccnt(__in_ecount_z(_MaxCount) const char * _Str,  size_t _MaxCount);
                 _CRTIMP unsigned int __cdecl _tcsnextc ( const char * _Str);
                 _CRTIMP char * __cdecl _tcsninc(__in_ecount_z(_Count) const char * _Ptr,  size_t _Count);
                 _CRTIMP char * __cdecl _tcsspnp( const char * _Str1,  const char * _Str2);
 
                 _CRTIMP char * __cdecl _tcslwr(__inout char *_Str);
                 _CRTIMP char * __cdecl _tcslwr_l(__inout char *_Str,  _locale_t _Locale);
                 _CRTIMP char * __cdecl _tcslwr_s(__inout_ecount(_SizeInChars) char *_Str,  size_t _SizeInChars);
                 _CRTIMP char * __cdecl _tcslwr_s_l(__inout_ecount(_SizeInChars) char *_Str,  size_t _SizeInChars,  _locale_t _Locale);
                 _CRTIMP char * __cdecl _tcsupr(__inout char *_Str);
                 _CRTIMP char * __cdecl _tcsupr_l(__inout char *_Str,  _locale_t _Locale);
                 _CRTIMP char * __cdecl _tcsupr_s(__inout_ecount(_SizeInChars) char *_Str,  size_t _SizeInChars);
                 _CRTIMP char * __cdecl _tcsupr_s_l(__inout_ecount(_SizeInChars) char *_Str,  size_t _SizeInChars,  _locale_t _Locale);
 
                 _CRTIMP  size_t __cdecl _tclen( const char * _Str);
                 _CRTIMP void __cdecl _tccpy(__out_z char * _DstCh,  const char * _SrcCh);
                 ...
                 __inline _CRPC _tcschr( _CPC _s1, _UI _c) {return (_CRPC)_mbschr((_CPUC)_s1,_c);}
                 __inline size_t _tcscspn( _CPC _s1, _CPC _s2) {return _mbscspn((_CPUC)_s1,(_CPUC)_s2);}
 
                 _CRT_INSECURE_DEPRECATE(_tcsncat_s) __inline char * _tcsncat( char *_Destination,  const char *_Source,  size_t _Count)
                 {
                     #pragma warning(push)
                     #pragma warning(disable:4996)
                 ...
                 __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_2(errno_t, _tcsncat_s, char, _Dest,  const char *, _Source,  size_t, _Count)
 
                 _CRT_INSECURE_DEPRECATE(_tcsncat_s_l) __inline char * _tcsncat_l( char *_Destination,  const char *_Source,  size_t _Count,  _locale_t _Locale)
                 {
                     #pragma warning(push)
                     #pragma warning(disable:4996)
                 ...
                 __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3(errno_t, _tcsncat_s_l, char, _Dest, const char *, _Source, size_t, _Count, _locale_t, _Locale)
 
                 _CRT_INSECURE_DEPRECATE(_tcsncpy_s) __inline char * _tcsncpy( char * _Destination, const char * _Source, size_t _Count)
                 {
                     #pragma warning(push)
                     #pragma warning(disable:4996)
                 ...
                 __inline __checkReturn_wat errno_t _tcsncpy_s( char * _Destination,  size_t _Destination_size_chars,  const char * _Source, size_t _Count)
                 {
                     return _mbsnbcpy_s((unsigned char *)_Destination, _Destination_size_chars, (const unsigned char *)_Source,_Count);
                 }
 
                 __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_2(errno_t, _tcsncpy_s, char, _Dest,  const char *, _Source,  size_t, _Count)
 
                 _CRT_INSECURE_DEPRECATE(_tcsncpy_s_l) __inline char * _tcsncpy_l( char * _Destination, const char * _Source, size_t _Count,  _locale_t _Locale)
                 {
                     #pragma warning(push)
                     #pragma warning(disable:4996)
                 ...
                 __inline __checkReturn_wat errno_t _tcsncpy_s_l( char * _Destination,  size_t _Destination_size_chars,  const char * _Source, size_t _Count,  _locale_t _Locale)
                 {
                     return _mbsnbcpy_s_l((unsigned char *)_Destination, _Destination_size_chars, (const unsigned char *)_Source,_Count, _Locale);
                 }
 
                 __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3(errno_t, _tcsncpy_s, char, _Dest,  const char *, _Source,  size_t, _Count,  _locale_t, _Locale)
 
                 __inline  _CRPC _tcspbrk( _CPC _s1, _CPC _s2) {return (_CRPC)_mbspbrk((_CPUC)_s1,(_CPUC)_s2);}
                 __inline  _CRPC _tcsrchr( _CPC _s1, _UI _c) {return (_CRPC)_mbsrchr((_CPUC)_s1,_c);}
                 __inline  size_t _tcsspn( _CPC _s1, _CPC _s2) {return _mbsspn((_CPUC)_s1,(_CPUC)_s2);}
                 __inline  _CRPC _tcsstr( _CPC _s1, _CPC _s2) {return (_CRPC)_mbsstr((_CPUC)_s1,(_CPUC)_s2);}
 
                 _CRT_INSECURE_DEPRECATE(_tcstok_s) __inline  char *  _tcstok( char * _String, const char * _Delimiters)
                 {
                     #pragma warning(push)
                     #pragma warning(disable:4996)
                 ...
                 _CRT_INSECURE_DEPRECATE(_tcstok_s_l) __inline  char *  _tcstok_l( char * _String, const char * _Delimiters,  _locale_t _Locale)
                 {
                     #pragma warning(push)
                     #pragma warning(disable:4996)
                 ...
                 _CRT_INSECURE_DEPRECATE(_tcsnset_s) __inline char * _tcsnset( char * _Dst,  unsigned int _Value ,  size_t _Count)
                 {
                     #pragma warning(push)
                     #pragma warning(disable:4996)
                 ...
                 _CRT_INSECURE_DEPRECATE(_tcsnset_s_l) __inline char * _tcsnset_l( char * _Dst,  unsigned int _Value ,  size_t _Count,  _locale_t _Locale)
                 {
                     #pragma warning(push)
                     #pragma warning(disable:4996)
                 ...
                 __inline __checkReturn_wat errno_t _tcsnset_s(__inout_bcount_z(_SizeInBytes) char * _Dst,  size_t _SizeInBytes,  unsigned int _Value ,  size_t _Count)
                 {
                     return _mbsnbset_s((unsigned char *)_Dst, _SizeInBytes, _Value, _Count);
                 }
 
                 __inline __checkReturn_wat errno_t _tcsnset_s_l(__inout_bcount_z(_SizeInBytes) char * _Dst,  size_t _SizeInBytes,  unsigned int _Value ,  size_t _Count,  _locale_t _Locale)
                 {
                 ...
                 _CRT_INSECURE_DEPRECATE(_tcsset_s) __inline char * _tcsset( char * _Dst,  unsigned int _Value)
                 {
                     #pragma warning(push)
                     #pragma warning(disable:4996)
                 ...
                 _CRT_INSECURE_DEPRECATE(_tscset_s_l) __inline char * _tcsset_l( char * _Dst,  unsigned int _Value,  _locale_t _Locale)
                 {
                     #pragma warning(push)
                     #pragma warning(disable:4996)
                 ...
                 __inline __checkReturn_wat errno_t _tcsset_s(__inout_bcount_z(_SizeInBytes) char * _Dst,  size_t _SizeInBytes,  unsigned int _Value)
                 {
                     return _mbsset_s((unsigned char *)_Dst, _SizeInBytes, _Value);
                 }
 
                 __inline __checkReturn_wat errno_t _tcsset_s_l(__inout_bcount_z(_SizeInBytes) char * _Dst,  size_t _SizeInBytes,  unsigned int _Value,  _locale_t _Locale)
                 {
                 ...
                 _CRT_INSECURE_DEPRECATE(_tscnccat_s) __inline char * _tcsnccat( char * _Destination,  const char * _Source,  size_t _Count)
                 {
                     #pragma warning(push)
                     #pragma warning(disable:4996)
                 ...
                 __inline __checkReturn_wat errno_t _tcsnccat_s(__inout_bcount_z(_Destination_size_chars) char * _Destination,  size_t _Destination_size_chars,  const char * _Source,  size_t _Count)
                 {
                     return _mbsncat_s((unsigned char *)_Destination, _Destination_size_chars, (const unsigned char *)_Source, _Count);
                 }
 
                 _CRT_INSECURE_DEPRECATE(_tcsnccat_s_l) __inline char * _tcsnccat_l( char * _Destination,  const char * _Source,  size_t _Count,  _locale_t _Locale)
                 {
                     #pragma warning(push)
                     #pragma warning(disable:4996)
                 ...
                 __inline __checkReturn_wat errno_t _tcsnccat_s_l(__inout_bcount_z(_Destination_size_chars) char * _Destination,  size_t _Destination_size_chars,  const char * _Source,  size_t _Count,  _locale_t _Locale)
                 {
                     return _mbsncat_s_l((unsigned char *)_Destination, _Destination_size_chars, (const unsigned char *)_Source, _Count, _Locale);
                 }
 
                 _CRT_INSECURE_DEPRECATE(_tcsnccpy_s) __inline char * _tcsnccpy( char * _Destination,  const char * _Source,  size_t _Count)
                 {
                     #pragma warning(push)
                     #pragma warning(disable:4996)
                 ...
                 __inline __checkReturn_wat errno_t _tcsnccpy_s(__out_bcount_z(_Destination_size_chars) char * _Destination,  size_t _Destination_size_chars,  const char * _Source,  size_t _Count)
                 {
                     return _mbsncpy_s((unsigned char *)_Destination, _Destination_size_chars, (const unsigned char *)_Source, _Count);
                 }
 
                 _CRT_INSECURE_DEPRECATE(_tcsnccpy_s_l) __inline char * _tcsnccpy_l(__out_bcount_z(_Count) char * _Destination,  const char * _Source,  size_t _Count,  _locale_t _Locale)
                 {
                     #pragma warning(push)
                     #pragma warning(disable:4996)
                 ...
                 __inline __checkReturn_wat errno_t _tcsnccpy_s_l(__out_bcount_z(_Destination_size_chars) char * _Destination,  size_t _Destination_size_chars,  const char * _Source,  size_t _Count,  _locale_t _Locale)
                 {
                     return _mbsncpy_s_l((unsigned char *)_Destination, _Destination_size_chars, (const unsigned char *)_Source, _Count, _Locale);
                 }
 
                 _CRT_INSECURE_DEPRECATE(_tcsncset_s) __inline char * _tcsncset(__inout_bcount(_Count) char *_Destination,  unsigned int _Value,  size_t _Count)
                 {
                     #pragma warning(push)
                     #pragma warning(disable:4996)
                 ...
                 __inline __checkReturn_wat errno_t _tcsncset_s(__out_bcount(_SizeInBytes) char *_Destination,  size_t _SizeInBytes,  unsigned int _Value,  size_t _Count)
                 {
                     return _mbsnset_s((unsigned char *)_Destination, _SizeInBytes, _Value, _Count);
                 }
 
                 _CRT_INSECURE_DEPRECATE(_tcsncset_s_l) __inline char * _tcsncset_l(__inout char *_Destination,  unsigned int _Value,  size_t _Count,  _locale_t _Locale)
                 {
                     #pragma warning(push)
                     #pragma warning(disable:4996)
                 ...
                 __inline __checkReturn_wat errno_t _tcsncset_s_l(__inout_bcount(_SizeInBytes) char *_Destination,  size_t _SizeInBytes,  unsigned int _Value,  size_t _Count,  _locale_t _Locale)
                 {
                 ...
                 _CRT_INSECURE_DEPRECATE(_tcslwr_s) __inline char * _tcslwr( char * _String)
                 {
                     #pragma warning(push)
                     #pragma warning(disable:4996)
                 ...
                 _CRT_INSECURE_DEPRECATE(_tcslwr_s_l) __inline char * _tcslwr_l( char * _String,  _locale_t _Locale)
                 {
                     #pragma warning(push)
                     #pragma warning(disable:4996)
                 ...
                 __inline __checkReturn_wat errno_t _tcslwr_s_l(__inout_bcount_z(_SizeInBytes) char * _String,  size_t _SizeInBytes,  _locale_t _Locale)
                 {
                     return _mbslwr_s_l((unsigned char *)_String, _SizeInBytes, _Locale);
                 }
 
                 __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_1(errno_t, _tcslwr_s_l, __inout_bcount(_Size) char, _String,  _locale_t, _Locale)
 
                 _CRT_INSECURE_DEPRECATE(_tcsupr_s) __inline char * _tcsupr( char * _String)
                 {
                     #pragma warning(push)
                     #pragma warning(disable:4996)
                 ...
                 __inline __checkReturn_wat errno_t _tcsupr_s(__inout_bcount_z(_Count) char * _String,  size_t _Count)
                 {
                 ...
                 _CRT_INSECURE_DEPRECATE(_tcsupr_s_l) __inline char * _tcsupr_l( char * _String,  _locale_t _Locale)
                 {
                     #pragma warning(push)
                     #pragma warning(disable:4996)
                 ...
                 __inline __checkReturn_wat errno_t _tcsupr_s_l(__inout_bcount_z(_Count) char * _String,  size_t _Count,  _locale_t _Locale)
                 {
                     return _mbsupr_s_l((unsigned char *)_String, _Count, _Locale);
                 }
 
                 __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_1(errno_t, _tcsupr_s_l, __inout_bcount(_Size) char, _String,  _locale_t, _Locale)
 
                 __inline  size_t _tclen( _CPC _s1) {return _mbclen((_CPUC)_s1);}
 
                 _CRT_INSECURE_DEPRECATE(_tccpy_s) __inline void _tccpy(__out_bcount_z(2) char * _Destination,  const char * _Source)
                 {
                     #pragma warning(push)
                     #pragma warning(disable:4996)
                 ...
                 _CRT_INSECURE_DEPRECATE(_tccpy_s_l) __inline void _tccpy_l(__out_bcount_z(2) char * _Destination,  const char * _Source,  _locale_t _Locale)
                 {
                     #pragma warning(push)
                     #pragma warning(disable:4996)
                 ...
                 __inline __checkReturn_wat errno_t _tccpy_s(__out_bcount_z(_SizeInBytes) char * _Destination, size_t _SizeInBytes, __out_opt int *_PCopied,  const char * _Source)
                 {
                     return _mbccpy_s((unsigned char *)_Destination, _SizeInBytes, _PCopied, (const unsigned char *)_Source);
                 }
 
                 __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_2(errno_t, _tccpy_s, __out_bcount(_SizeInBytes) char, _Dest, __out_opt  int *, _PCopied,  const char *, _Source)
 
                 __inline __checkReturn_wat errno_t _tccpy_s_l(__out_bcount_z(_SizeInBytes) char * _Destination,  size_t _SizeInBytes, __out_opt int *_PCopied,  const char * _Source,  _locale_t _Locale)
                 {
                     return _mbccpy_s_l((unsigned char *)_Destination, _SizeInBytes, _PCopied, (const unsigned char *)_Source, _Locale);
                 }
 
                 __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3(errno_t, _tccpy_s_l, __out_bcount(_Size) char, _Dest, __out_opt int *, _PCopied,  const char *, _Source,  _locale_t, _Locale)
                 ...
                 __inline  _UI _tcsnextc( _CPC _s1)
                 {
                     ...
                     extern "C++" {
                     inline  char * __QCMP_CALLCON _tcschr( char *_S,  unsigned int _C)
                             {return ((char *)_tcschr((const char *)_S, _C)); }
                     inline  char * __QCMP_CALLCON _tcspbrk( char *_S,  const char *_P)
                             {return ((char *)_tcspbrk((const char *)_S, _P)); }
                     inline  char * __QCMP_CALLCON _tcsrchr( char *_S,  unsigned int _C)
                             {return ((char *)_tcsrchr((const char *)_S, _C)); }
                     inline  char * __QCMP_CALLCON _tcsstr( char *_S,  const char *_P)
         ...
         #else  /* __STDC__ || defined (_NO_INLINING) */
             __inline  size_t __QCMP_CALLCON _tclen( const char *_cpc)
             {
                 /* avoid compiler warning */
                 (void *)_cpc;
                 return 1;
             }
             __inline void __QCMP_CALLCON _tccpy( char *_pc1,  const char *_cpc2) { *_pc1 = *_cpc2; }
             __inline  int __QCMP_CALLCON _tccmp( const char *_cpc1,  const char *_cpc2) { return (int) (((unsigned char)*_cpc1)-((unsigned char)*_cpc2)); }
         #endif  /* __STDC__ || defined (_NO_INLINING) */
         ...
         //#endif  /* NULL */
             ...
             _CRTIMP size_t  __cdecl __strncnt(__in_ecount_z(_Cnt) const char * _Str,  size_t _Cnt);
         ...
         #else  /* __STDC__ || defined (_NO_INLINING) */
             __inline  char * __QCMP_CALLCON _strdec( const char * _Cpc1,  const char * _Cpc2) { return (char *)((_Cpc1)>=(_Cpc2) ? NULL : (_Cpc2-1)); }
             __inline  char * __QCMP_CALLCON _strinc( const char * _Pc) { return (char *)(_Pc+1); }
             __inline  unsigned int __QCMP_CALLCON _strnextc( const char * _Cpc) { return (unsigned int)*(const unsigned char *)_Cpc; }
             __inline  char * __QCMP_CALLCON _strninc( const char * _Pc,  size_t _Sz) { return (char *)(_Pc+_Sz); }
             __inline  size_t __QCMP_CALLCON _strncnt( const char * _String,  size_t _Cnt)
             {
                     size_t n = _Cnt;
             ...
             __inline  char * __QCMP_CALLCON _strspnp
             (
                  const char * _Cpc1,
                  const char * _Cpc2
             )
 ...
 /*
             _CRT_INSECURE_DEPRECATE(_strncpy_s_l) __inline char * __QCMP_CALLCON _strncpy_l( char *_Destination,  const char *_Source,  size_t _Count,  _locale_t _Locale)
             {
                 __QCMP_UNREF(_Locale);
                 #pragma warning( push )
                 #pragma warning( disable : 4996 )
 ...
 */
             #if __STDC_WANT_SECURE_LIB__
                 __inline errno_t __QCMP_CALLCON _strncpy_s_l( char *_Destination,  size_t _Destination_size_chars,  const char *_Source,  size_t _Count,  _locale_t _Locale)
                 {
                     __QCMP_UNREF(_Locale);
                     #pragma warning( push )
                     #pragma warning( disable : 4996 )
...
//             __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3(errno_t, _strncpy_s_l,  char, _Dest,  const char *, _Source,  size_t, _Count,  _locale_t, _Locale)
/* 
             _CRT_INSECURE_DEPRECATE(_strncat_s_l) __inline char * __QCMP_CALLCON _strncat_l( char *_Destination,  const char *_Source,  size_t _Count,  _locale_t _Locale)
             {
                 __QCMP_UNREF(_Locale);
                 #pragma warning( push )
                 #pragma warning( disable : 4996 6054 )
 ...
 */
             #if __STDC_WANT_SECURE_LIB__
                 __inline errno_t __QCMP_CALLCON _strncat_s_l( char *_Destination,  size_t _Destination_size_chars,  const char *_Source,  size_t _Count,  _locale_t _Locale)
                 {
                     __QCMP_UNREF(_Locale);
                     #pragma warning(push)
                     #pragma warning(disable:4996)
...
//             __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3(errno_t, _strncat_s_l, __inout_ecount_z(_Size) char, _Dest,  const char *, _Source,  size_t, _Count,  _locale_t, _Locale)
/* 
             _CRT_INSECURE_DEPRECATE(_strtok_s_l) __inline  char *  _strtok_l( char * _String,  const char * _Delimiters,  _locale_t _Locale)
             {
                 __QCMP_UNREF(_Locale);
                 #pragma warning(push)
                 #pragma warning(disable:4996)
 ...
 */
                 ...
                 __inline char * __QCMP_CALLCON _strnset_l( char *_Destination,  int _Value,  size_t _Count,  _locale_t _Locale)
                 {
                     __QCMP_UNREF(_Locale);
                     #pragma warning( push )
                     #pragma warning( disable : 4996 6054 )
                 ...
                 __inline errno_t __QCMP_CALLCON _strnset_s_l( char *_Destination,  size_t _Destination_size_chars,  int _Value,  size_t _Count,  _locale_t _Locale)
                 {
                     __QCMP_UNREF(_Locale);
                     #pragma warning( push )
                     #pragma warning( disable : 4996 )
                 ...
                 __inline char * __QCMP_CALLCON _strset_l( char * _Destination,  int _Value,  _locale_t _Locale)
                 {
                     __QCMP_UNREF(_Locale);
                     #pragma warning( push )
                     #pragma warning( disable : 4996 )
                 ...
                 __inline errno_t __QCMP_CALLCON _strset_s_l( char *_Destination,  size_t _Destination_size_chars,  int _Value,  _locale_t _Locale)
                 {
                     __QCMP_UNREF(_Locale);
                     #pragma warning( push )
                     #pragma warning( disable : 4996 )
