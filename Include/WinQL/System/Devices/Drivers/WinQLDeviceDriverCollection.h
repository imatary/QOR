...
//Win32 Device Driver Collection
...
namespace nsWin32
{
	...
	public:
		...
		CDeviceDriverCollection& operator = ( const CDeviceDriverCollection& src );
		virtual ~CDeviceDriverCollection();
...
#endif//WINQL_DEVICEDRIVERCOLLECTION_H_3
