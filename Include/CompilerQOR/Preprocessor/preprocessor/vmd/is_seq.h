...
#if !defined(QOR_VMD_IS_SEQ_H)
#define QOR_VMD_IS_SEQ_H

#include "CompilerQOR/Preprocessor/preprocessor/vmd/detail/setup.h"

#if QOR_PP_VARIADICS

#include "CompilerQOR/Preprocessor/preprocessor/vmd/detail/is_seq.h"
...
#define QOR_VMD_IS_SEQ(sequence) \
    QOR_VMD_DETAIL_IS_SEQ(sequence) \
/**/

/** \def QOR_VMD_IS_SEQ_D(d,sequence)
...
#define QOR_VMD_IS_SEQ_D(d,sequence) \
    QOR_VMD_DETAIL_IS_SEQ_D(d,sequence) \
/**/

#endif /* QOR_PP_VARIADICS */
#endif /* QOR_VMD_IS_SEQ_H */
