...
namespace nsWin32
{
	...
	//--------------------------------------------------------------------------------
	CWinCtrlParentController::CWinCtrlParentController( nsMammut::CModel* pModelItem, nsAppocrita::CController* pParent ) : CBaseWindowPartController( pModelItem, pParent )
	{
