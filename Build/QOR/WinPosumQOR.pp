...
//Set WinPosumQOR specific definitions and overrides

#define QOR_MODULE_NAME WinPosumQOR

//Append the module specific PP defines to the list from the Operating System
#define QOR_CONFIG_DEFINES_WINPOSUMQOR1 QOR_PP_LIST_APPEND( QOR_CONFIG_DEFINES_OS,("__WINPOSUMQOR") )
#define QOR_CONFIG_DEFINES_WINPOSUMQOR2 QOR_PP_LIST_APPEND( QOR_CONFIG_DEFINES_WINPOSUMQOR1,("_LIBCPP_DLL") )
#define QOR_CONFIG_DEFINES_MODULE QOR_PP_LIST_APPEND( QOR_CONFIG_DEFINES_WINPOSUMQOR2,("") )
...
#define SOURCE_PATH ../../../Source/SystemQOR/MSWindows/WinPosum/
#define SOURCES	(WinPosum)\
				(WinPosumLibraryLoader)\
				(WinPosumMemoryManager)\
				(WinPosumPath)\
				(WinPosumProcess)\
				(WinPosumSharedLibrary)\
				(WinPosumStdio)\
				(WinPosumStream)\
				(WinPosumStream_Buffering)\
				(WinPosumStream_Close)\
				(WinPosumStream_Position)\
				(WinPosumStream_PrintScan)\
				(WinPosumStream_PutGet)\
				(WinPosumStream_ReadWrite)\
				(WinPosumString)
