...
#include "WinQL/COM/Server/OLE/WinQLOLEServer.h"
...
{
	//--------------------------------------------------------------------------------
	__QOR_IMPLEMENT_OCLASS_LUID( COLEServer );

__QCMP_WARNING_PUSH
__QCMP_WARNING_DISABLE( __QCMP_WARN_THIS_USED_IN_BASE_INIT_LIST )
	//--------------------------------------------------------------------------------
	COLEServer::COLEServer() : m_ClassFactoryPtr( this )
	...
	{
		_WINQ_FCONTEXT( "COLEServer::COLEServer" );
	}
__QCMP_WARNING_POP //( __QCMP_WARN_THIS_USED_IN_BASE_INIT_LIST )
	...
	//--------------------------------------------------------------------------------
	//Gaurantee availaility of required interfaces
	void COLEServer::Initialize()
	{
		_WINQ_FCONTEXT( "COLEServer::Initialize" );
		m_ClassFactoryPtr.operator&();
	}
