...
#ifndef QURSES_GUI_VERTICAL_H_3
#define	QURSES_GUI_VERTICAL_H_3

//--------------------------------------------------------------------------------
namespace nsQurses
{
	//--------------------------------------------------------------------------------
	class __QOR_INTERFACE( QURSES_QOR ) CQGVertical : public CQGLayout
	{
	public:		

		__QOR_DECLARE_OCLASS_ID( CQGVertical );

		CQGVertical();
		CQGVertical( const CQGVertical& );
		CQGVertical& operator = ( const CQGVertical& );
		virtual ~CQGVertical();
