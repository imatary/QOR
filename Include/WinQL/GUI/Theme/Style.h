...
namespace nsWin32
{
	// Custom draw return flags values under 0x00010000 are reserved for global custom draw values. Above that are for specific controls
	...
	__QCMP_STATIC_CONSTANT( unsigned long,	CDRF_NotifytemDraw      = 0x00000020 );
#if (_WIN32_IE >= 0x0400)
	...
	__QCMP_STATIC_CONSTANT( unsigned long,	CDDS_PrePaint           = 0x00000001 );
	__QCMP_STATIC_CONSTANT( unsigned long,	CDDS_PostPaint          = 0x00000002 );
	__QCMP_STATIC_CONSTANT( unsigned long,	CDDS_PreErase           = 0x00000003 );
	__QCMP_STATIC_CONSTANT( unsigned long,	CDDS_PostErase          = 0x00000004 );

	// the 0x000010000 bit means it's individual item specific
	__QCMP_STATIC_CONSTANT( unsigned long,	CDDS_Item               = 0x00010000 );
	__QCMP_STATIC_CONSTANT( unsigned long,	CDDS_ItemPrepaint       = ( CDDS_Item | CDDS_PrePaint ) );
	__QCMP_STATIC_CONSTANT( unsigned long,	CDDS_ItemPostPaint      = ( CDDS_Item | CDDS_PostPaint ) );
	__QCMP_STATIC_CONSTANT( unsigned long,	CDDS_ItemPreErase       = ( CDDS_Item | CDDS_PreErase ) );
	__QCMP_STATIC_CONSTANT( unsigned long,	CDDS_ItemPostErase      = ( CDDS_Item | CDDS_PostErase ) );
#if (_WIN32_IE >= 0x0400)
	__QCMP_STATIC_CONSTANT( unsigned long,	CDDS_SubItem            = 0x00020000 );
#endif

	//ItemState flags
	__QCMP_STATIC_CONSTANT( unsigned short,	CDIS_Selected           = 0x0001 );
	__QCMP_STATIC_CONSTANT( unsigned short,	CDIS_Grayed             = 0x0002 );
	__QCMP_STATIC_CONSTANT( unsigned short,	CDIS_Disabled           = 0x0004 );
	__QCMP_STATIC_CONSTANT( unsigned short,	CDIS_Checked            = 0x0008 );
	__QCMP_STATIC_CONSTANT( unsigned short,	CDIS_Focus              = 0x0010 );
	__QCMP_STATIC_CONSTANT( unsigned short,	CDIS_Default            = 0x0020 );
	__QCMP_STATIC_CONSTANT( unsigned short,	CDIS_Hot                = 0x0040 );
	__QCMP_STATIC_CONSTANT( unsigned short,	CDIS_Marked             = 0x0080 );
	__QCMP_STATIC_CONSTANT( unsigned short,	CDIS_Indeterminate      = 0x0100 );
#if (_WIN32_WINNT >= 0x0501)
	__QCMP_STATIC_CONSTANT( unsigned short,	CDIS_ShowKetboardCues   = 0x0200 );
#endif
#if (_WIN32_WINNT >= 0x0600)
	__QCMP_STATIC_CONSTANT( unsigned short,	CDIS_NearHot            = 0x0400 );
	__QCMP_STATIC_CONSTANT( unsigned short,	CDIS_OtherSideHot       = 0x0800 );
	__QCMP_STATIC_CONSTANT( unsigned short,	CDIS_DropHighlighted    = 0x1000 );
#endif
...
#ifndef _WIN64
		__QCMP_STATIC_CONSTANT( int, GWL_WNDPROC         = (-4) );
		__QCMP_STATIC_CONSTANT( int, GWL_HINSTANCE       = (-6) );
		__QCMP_STATIC_CONSTANT( int, GWL_HWNDPARENT      = (-8) );
		__QCMP_STATIC_CONSTANT( int, GWL_USERDATA        = (-21) );
#endif
		__QCMP_STATIC_CONSTANT( int, GWL_STYLE           = (-16) );
		__QCMP_STATIC_CONSTANT( int, GWL_EXSTYLE         = (-20) );		
		__QCMP_STATIC_CONSTANT( int, GWL_ID              = (-12) );

		__QCMP_STATIC_CONSTANT( int, GWLP_WNDPROC         = (-4) );
		__QCMP_STATIC_CONSTANT( int, GWLP_HINSTANCE       = (-6) );
		__QCMP_STATIC_CONSTANT( int, GWLP_HWNDPARENT      = (-8) );
		__QCMP_STATIC_CONSTANT( int, GWLP_USERDATA        = (-21) );
		__QCMP_STATIC_CONSTANT( int, GWLP_ID			  = (-12) );
