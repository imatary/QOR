...
#ifndef WINQL_IO_SOCKETCLIENTADAPTOR_H_3
#define WINQL_IO_SOCKETCLIENTADAPTOR_H_3
...
{
	//--------------------------------------------------------------------------------
	//Adapt a general SocketConnector for use as a connection on the client side
	class __QOR_INTERFACE( __WINQL ) CSocketClientAdaptor : public CSocketConnector
	{
	public:
...
#endif//WINQL_IO_SOCKETCLIENTADAPTOR_H_3
