...
static __inline int accept4(int s, struct sockaddr * addr, socklen_t *addrlen, int flags)
{
...
//------------------------------------------------------------------------------
static __inline socket_t accept_cloexec(socket_t sockfd, struct sockaddr *addr, socklen_t *addrlen)
{
#ifdef SOCK_CLOEXEC
