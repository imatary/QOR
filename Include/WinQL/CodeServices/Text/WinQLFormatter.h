...
//WinQL stream output formatter

#ifndef WINQL_FILE_FORMATTER_H_2
#define WINQL_FILE_FORMATTER_H_2
...
#define POSITION_CHAR _T('$')
	...
	//--------------------------------------------------------------------------------
	class __QOR_INTERFACE( __WINQL ) CFormatter
	{
	public:
		...
		void write_charA( char ch, CCRTFile* f, int* pnumwritten );
		void write_charW( wchar_t ch, CCRTFile* f, int* pnumwritten );
		void write_multi_charA( char ch, int num, int* pnumwritten );
		void write_multi_charW( wchar_t ch, int num, int* pnumwritten );
		void write_multi_charA( char ch, int num, CCRTFile *f, int *pnumwritten );
		void write_multi_charW( wchar_t ch, int num, CCRTFile *f, int *pnumwritten );
		void write_stringA( char* string, int len, int* pnumwritten );
		void write_stringW( wchar_t* string, int len, int* pnumwritten );
		void write_stringA( char* string, int len, CCRTFile* f, int* pnumwritten );
		void write_stringW( wchar_t* string, int len, CCRTFile* f, int* pnumwritten );
...
#endif//WINQL_FILE_FORMATTER_H_2
