...
//Base CRT class for utmpx

#ifndef SYSTEMQOR_POSIX_UTMPX_H_3
#define SYSTEMQOR_POSIX_UTMPX_H_3
...
namespace nsBaseCRT
{
	using nsPlatform::utmpx;

	//--------------------------------------------------------------------------------
    class __QOR_INTERFACE( __QSYS ) Cutmpx
    {
    public:

		__QOR_DECLARE_OCLASS_ID( Cutmpx );
...
#endif//SYSTEMQOR_POSIX_UTMPX_H_3
