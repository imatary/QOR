...
namespace nsBaseCRT
{
	__QOR_IMPLEMENT_OCLASS_LUID( Clocale );
	...
	{
		__QCS_MEMBER_FCONTEXT( "Clocale::duplocale" );
		errno = ENOSYS;
		return 0;
	}
	...
	{
		__QCS_MEMBER_FCONTEXT( "Clocale::freelocale" );
	}

	//--------------------------------------------------------------------------------
    lconv* Clocale::localeconv( void )
	{
		__QCS_MEMBER_FCONTEXT( "Clocale::localeconv" );
		errno = ENOSYS;
		return 0;
	}
	...
	{
		__QCS_MEMBER_FCONTEXT( "Clocale::newlocale" );
		errno = ENOSYS;
		return 0;
	}
	...
	{
		__QCS_MEMBER_FCONTEXT( "Clocale::setlocale" );
		errno = ENOSYS;
		return 0;
	}
	...
	{
		__QCS_MEMBER_FCONTEXT( "Clocale::uselocale" );
		errno = ENOSYS;
		return 0;
	}
