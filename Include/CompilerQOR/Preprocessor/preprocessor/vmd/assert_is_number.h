...
#if !defined(QOR_VMD_ASSERT_IS_NUMBER_H)
#define QOR_VMD_ASSERT_IS_NUMBER_H
...
/** \def QOR_VMD_ASSERT_IS_NUMBER(sequence)
...
#define QOR_VMD_ASSERT_IS_NUMBER(sequence)
...
#define QOR_VMD_ASSERT_IS_NUMBER(sequence) \
    QOR_VMD_ASSERT \
          ( \
          QOR_VMD_IS_NUMBER(sequence), \
          QOR_VMD_IS_NUMBER_ASSERT_ERROR \
          ) \
/**/
...
#endif /* QOR_VMD_ASSERT_IS_NUMBER_H */
