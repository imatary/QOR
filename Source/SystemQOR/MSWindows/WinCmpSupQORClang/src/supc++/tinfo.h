...
namespace __cxxabiv1
{
	...
	// __upcast_result is used to hold information during traversal of a class hierarchy when catch matching.
	...
	// __dyncast_result is used to hold information during traversal of a class hierarchy when dynamic casting.
	struct __class_type_info::__dyncast_result
	{
		...
		__dyncast_result( int details_ = __vmi_class_type_info::__flags_unknown_mask ) :dst_ptr( NULL ), whole2dst( __unknown ),
			whole2src( __unknown ), dst2src( __unknown ), whole_details( details_ )
		{
		}
