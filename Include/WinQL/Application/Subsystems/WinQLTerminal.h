...
#ifndef WINQL_SUBSYS_TERMINAL_H_1
#define WINQL_SUBSYS_TERMINAL_H_1
...
namespace nsWin32
{
	...
	//--------------------------------------------------------------------------------
	class __QOR_INTERFACE( __WINQL ) CTerminal : public nsQOR::CSubSystem
	{
	public:

		__QOR_DECLARE_OCLASS_ID( CTerminal );

		__QOR_IMPL_REF( CTerminal );

		static nsCodeQOR::CTExternalRegEntry< CTerminal > RegEntry;
		...
		CConsole::ref_type Console( void );

	private:

		CConsole::ref_type m_Console;
	};

}//nsWin32

#endif//WINQL_SUBSYS_TERMINAL_H_1
