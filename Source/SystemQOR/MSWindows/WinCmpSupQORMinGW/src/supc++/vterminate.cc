...
_GLIBCXX_BEGIN_NAMESPACE_VERSION
  ...
  void __verbose_terminate_handler()
  {
    ...
    if (terminating)
      {
	//TODO: fputs("terminate called recursively\n", stderr);
	abort ();
      }
    terminating = true;
	...
	char const *name = t->name();
	{
	  ...
	  //TODO: fputs("terminate called after throwing an instance of '", stderr);
	  //TODO:
	  /*if (status == 0)
	    fputs(dem, stderr);
	  else
...
*/
    ...
    //TODO: else
      //TODO: fputs("terminate called without an active exception\n", stderr);
