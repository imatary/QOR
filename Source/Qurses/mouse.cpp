...
int request_mouse_pos( void )
{
    __QCS_FCONTEXT( "request_mouse_pos" );
...
void wmouse_position( WINDOW* win, int* y, int* x )
{
	__QCS_FCONTEXT( "wmouse_position" );
...
mmask_t mousemask( mmask_t mask, mmask_t* oldmask )
{
    ...
    // The ncurses interface doesn't work with our move events, so filter them here
