...
#ifndef ARCHQOR_Z_HLASSEMBLER_CONTEXT_H_1
#define ARCHQOR_Z_HLASSEMBLER_CONTEXT_H_1

#include "CompilerQOR.h"
#include "ArchQOR/Common/HLAssembler/Emittables/Emittable.h"
#include "Z_HLAssembler.h"
...
{	
	...
	class __QOR_INTERFACE( __ARCHQOR ) CZHLAContext : public CHLAssemblerContextBase
	{
	public:

		CZHLAContext( nsArch::CHighLevelAssemblerBase* compiler ) __QCMP_THROW;
		~CZHLAContext() __QCMP_THROW;
	...
	private:
		...
		__QCS_DECLARE_NONCOPYABLE( CZHLAContext );
...
#endif//ARCHQOR_Z_HLASSEMBLER_CONTEXT_H_1
