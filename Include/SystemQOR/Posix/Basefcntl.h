...
//Base CRT class for Cfcntl

#ifndef SYSTEMQOR_POSIX_FCNTL_H_3
#define SYSTEMQOR_POSIX_FCNTL_H_3
...
namespace nsBaseCRT
{
    ...
    //--------------------------------------------------------------------------------
    class __QOR_INTERFACE( __QSYS ) Cfcntl
    {
    public:
        ...
        virtual int fcntl( int, int, va_list vargs );
...
#endif//SYSTEMQOR_POSIX_FCNTL_H_3
