...
#ifndef QOR_ASCIICONFIG_H_1
#define QOR_ASCIICONFIG_H_1
...
#if( QOR_ARCH == X86_32 || QOR_ARCH == X86_64 )
...
#		define __QCMP_REPORTCONIG				__QCS_YES_			//Set to __QCS_YES_ at the top of a source file to get config output during compilation where supported
#	endif
...
#		define __QOR_PERFORMANCE				0					//Tune level of error checking and size vs performance 0=ponderous safety - 10=reckless haste
#	endif
...
#		define __QOR_CODE_COVERAGE				( __QCS_YES_ )		//Produce build output messages for input to BlanketQOR Code Coverage tool where supported
#	endif
