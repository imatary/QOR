...
#ifndef	QOR_SEARCH_H_3
#define QOR_SEARCH_H_3

#include "SystemQOR.h"
#include QOR_SYS_PLATFORMTYPES(search)

typedef nsPlatform::ENTRY ENTRY;
typedef nsPlatform::ACTION ACTION;
typedef nsPlatform::VISIT VISIT;
