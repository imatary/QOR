...
__QCMP_STARTLINKAGE_C
	...
	{
		static nsCodeQOR::mxGUID WinQL_Media = { 0xc7d7d6c0, 0x5480, 0x4115, { 0xad, 0x36, 0x1e, 0x3f, 0xf7, 0x20, 0x42, 0x58 } };
		return &WinQL_Media;
	}
...
//------------------------------------------------------------------------------
//Provide a Module Context that represents the WinQL-Media DLL
nsCodeQOR::CLoadableModuleBase& ThisModule( void )
{
	static nsCodeQOR::CLoadableModuleBase WinQLModule( "Querysoft Open Runtime Media Foundation class library for Microsoft Windows" );
	return WinQLModule;
}
