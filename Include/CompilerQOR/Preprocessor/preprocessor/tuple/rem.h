...
#ifndef QOR_PREPROCESSOR_TUPLE_REM_H_1
#define QOR_PREPROCESSOR_TUPLE_REM_H_1
...
#       define QOR_PP_TUPLE_REM_CTOR( size, tuple ) QOR_PP_TUPLE_REM_CTOR_I( QOR_PP_TUPLE_REM( size ), tuple )
#   else
#       define QOR_PP_TUPLE_REM_CTOR( size, tuple )		QOR_PP_TUPLE_REM_CTOR_D( size, tuple )
#       define QOR_PP_TUPLE_REM_CTOR_D( size, tuple )	QOR_PP_TUPLE_REM_CTOR_I( QOR_PP_TUPLE_REM( size ), tuple )
#   endif
#   if ~QOR_PP_CONFIG_FLAGS() & QOR_PP_CONFIG_MWCC()
#       define QOR_PP_TUPLE_REM_CTOR_I( ext, tuple )	ext tuple
#   else
#       define QOR_PP_TUPLE_REM_CTOR_I( ext, tuple )	QOR_PP_TUPLE_REM_CTOR_OO( ( ext, tuple ) )
#       define QOR_PP_TUPLE_REM_CTOR_OO( par )			QOR_PP_TUPLE_REM_CTOR_II ## par
#       define QOR_PP_TUPLE_REM_CTOR_II( ext, tuple )	ext ## tuple
#   endif
#endif

#endif//QOR_PREPROCESSOR_TUPLE_REM_H_1
