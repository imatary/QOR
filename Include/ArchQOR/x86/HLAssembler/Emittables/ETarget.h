...
#ifndef ARCHQOR_X86_ETARGET_H_2
#define ARCHQOR_X86_ETARGET_H_2
...
namespace nsx86
{
	...
	public:
		...
		//------------------------------------------------------------------------------
		// Return label bound to this target.
		inline const CLabel& getLabel() const __QCMP_THROW 
		{ 
			return m_Label; 
		}
