...
namespace nsWin32
{
	...
	public:
		...
		__QOR_DECLARE_OCLASS_ID( CMailSlotSink );

		CMailSlotSink( CMailSlotConnector* pPipeConnector );
		virtual ~CMailSlotSink();

		virtual bool Write( unsigned long& ulNumberOfBytesWritten, unsigned long ulNumberOfBytesToWrite );

	};

}//nsWin32

#endif//WINQL_IO_MAILSLOTSINK_H_3
