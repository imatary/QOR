...
//Base CRT class for Clocale

#ifndef SYSTEMQOR_POSIX_LOCALE_H_3
#define SYSTEMQOR_POSIX_LOCALE_H_3
...
namespace nsBaseCRT
{
    using nsPlatform::lconv;
	using nsPlatform::locale_t;

    //--------------------------------------------------------------------------------
    class __QOR_INTERFACE( __QSYS ) Clocale
    {
    
	public:

		__QOR_DECLARE_OCLASS_ID( Clocale );
...
#endif//SYSTEMQOR_POSIX_LOCALE_H_3
