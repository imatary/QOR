...
#ifndef _LINQL_EXEPAGEALLOCATOR_H_
#define _LINQL_EXEPAGEALLOCATOR_H_
...
{
	//--------------------------------------------------------------------------------
	class __QOR_INTERFACE( __LINQL ) CExePageAllocator
	{
	public:
		...
		virtual void Free( nsCodeQOR::CProcessBase* pProcess, void* addr, Cmp_uint_ptr );
...
#endif//_LINQL_EXEPAGEALLOCATOR_H_
