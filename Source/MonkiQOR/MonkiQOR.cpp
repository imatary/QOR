...
__QCMP_STARTLINKAGE_C
	...
	//------------------------------------------------------------------------------
	//This gives the QOR View library (MonkiQOR) a unique identity and marks it as a QOR module
	//with delayed static initialization and an accessible Module Context
	__QCMP_EXPORT nsCodeQOR::mxGUID* QORidentity( void )
	{
		static nsCodeQOR::mxGUID MonkiQOR = { 0x6d8a9cb5, 0x7ab7, 0x47f1, { 0x87, 0x9c, 0x55, 0x9e, 0x94, 0xfa, 0x86, 0xa4 } };
		return &MonkiQOR;
	}
...
__QCMP_ENDLINKAGE_C
	...
	{
		static nsCodeQOR::CLoadableModuleBase MonkiQORModule( "Querysoft Open Runtime MVC View Library (Monki)" );
		return MonkiQORModule;
	}
