...
//Base CRT class for sys/mman

#ifndef SYSTEMQOR_POSIX_SYS_MMAN_H_3
#define SYSTEMQOR_POSIX_SYS_MMAN_H_3
...
namespace nsBaseCRT
{
	...
	using nsPlatform::posix_typed_mem_info;
	using nsPlatform::mode_t;

    //--------------------------------------------------------------------------------
    class __QOR_INTERFACE( __QSYS ) Csys_mman
    {
    public:

		__QOR_DECLARE_OCLASS_ID(Csys_mman);
	...
	private:
		...
		Csys_mman( const Csys_mman& );
		Csys_mman& operator = ( const Csys_mman& );
    };

}//nsBaseCRT

#endif//SYSTEMQOR_POSIX_SYS_MMAN_H_3
