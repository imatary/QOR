...
const ios_base::fmtflags ios_base::boolalpha =		0x0001;
const ios_base::fmtflags ios_base::dec =			0x0002;
const ios_base::fmtflags ios_base::fixed = 0x0004;
const ios_base::fmtflags ios_base::hex = 0x0008;
const ios_base::fmtflags ios_base::internal = 0x0010;
const ios_base::fmtflags ios_base::left = 0x0020;
const ios_base::fmtflags ios_base::oct = 0x0040;
const ios_base::fmtflags ios_base::right = 0x0080;
const ios_base::fmtflags ios_base::scientific = 0x0100;
const ios_base::fmtflags ios_base::showbase = 0x0200;
const ios_base::fmtflags ios_base::showpoint = 0x0400;
const ios_base::fmtflags ios_base::showpos = 0x0800;
const ios_base::fmtflags ios_base::skipws = 0x1000;
const ios_base::fmtflags ios_base::unitbuf = 0x2000;
const ios_base::fmtflags ios_base::uppercase = 0x4000;
...
const ios_base::iostate ios_base::badbit = 0x1;
const ios_base::iostate ios_base::eofbit = 0x2;
const ios_base::iostate ios_base::failbit = 0x4;
