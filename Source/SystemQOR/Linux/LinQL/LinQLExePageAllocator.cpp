...
#include "SystemQOR.h"
#include <assert.h>
#include "LinQL/ExePageAllocator.h"
//#include "LinQL/CodeServices/Process.h"
...
/*
		nsCodeServices::CProcess* pWinProcess = dynamic_cast< nsCodeServices::CProcess* >( pProcess );
		...
		if( pWinProcess )
		{
			...
			void* mbase = nsWinQAPI::CKernel32::VirtualAllocEx( pWinProcess->Handle(), 0, msize, MEM_COMMIT | MEM_RESERVE, protect );
			if( mbase == 0 )
			{
				return 0;
			}
	...
	void CExePageAllocator::Free( nsCodeQOR::CProcessBase* pProcess, void* addr, Cmp_uint_ptr /* length */ )
	{
		...
		if( pWinProcess )
		{
			nsWinQAPI::CKernel32::VirtualFreeEx( pWinProcess->Handle(), addr, 0, MEM_RELEASE );
		}
		*/
	}
