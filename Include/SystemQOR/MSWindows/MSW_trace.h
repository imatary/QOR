...
//MSWindows overrides for trace

#ifndef SYSTEMQOR_MSW_TRACE_H_3
#define SYSTEMQOR_MSW_TRACE_H_3

#include "SystemQOR/Posix/Basetrace.h"

//--------------------------------------------------------------------------------
namespace nsWin32
{
	//--------------------------------------------------------------------------------
	class __QOR_INTERFACE( __QSYS ) Ctrace : public nsBaseCRT::Ctrace
	{
	public:
