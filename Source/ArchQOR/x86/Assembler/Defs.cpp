...
{
	//------------------------------------------------------------------------------
	const Cmp_unsigned__int32 ConditionToInstruction::_jcctable[ 16 ] =
	{
		INST_JO,
		INST_JNO,
		INST_JB,
	...
	//------------------------------------------------------------------------------
	const Cmp_unsigned__int32 ConditionToInstruction::_cmovcctable[16] =
	{
		INST_CMOVO,
		INST_CMOVNO,
		INST_CMOVB,
	...
	//------------------------------------------------------------------------------
	const Cmp_unsigned__int32 ConditionToInstruction::_setcctable[ 16 ] =
	{
		INST_SETO,
		INST_SETNO,
		INST_SETB,
...
#	define O(o) InstructionDescription::O_##o
	...
	const InstructionDescription instructionDescription[] =
	{
		...
		MAKE_INST(INST_SHUFPD           , "shufpd"           , G(MMU_RM_IMM8)   , F(MOV)           , O(XMM)              , O(XMM_MEM)          , 0, 0x66000FC6, 0),
		MAKE_INST(INST_SHUFPS           , "shufps"           , G(MMU_RM_IMM8)   , F(MOV)           , O(XMM)              , O(XMM_MEM)          , 0, 0x00000FC6, 0),
