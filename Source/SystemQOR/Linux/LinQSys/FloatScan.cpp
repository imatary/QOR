...
#include "LinQSys/shgetc.h"
#include "LinQSys/floatscan.h"

#if LIN_LDBL_MANT_DIG == 53 && LIN_LDBL_MAX_EXP == 1024
...
namespace nsLinux
{
    ...
    //------------------------------------------------------------------------------
    long long scanexp(FILE *f, int pok)
    {
        int c;
        int x;
        long long y;
    ...
    //------------------------------------------------------------------------------
    long double decfloat(FILE *f, int c, int bits, int emin, int sign, int pok)
    {
        uint32_t x[KMAX];
        ...
        if ((e2+LDBL_MANT_DIG & INT_MAX) > emax-5) {
            if (fabs(y) >= CONCAT(0x1p, LIN_LDBL_MANT_DIG)) {
