...
{
    __QCS_FCONTEXT( "use_default_colors" );
...
//------------------------------------------------------------------------------
__QOR_INTERFACE( QURSES_QOR ) int PDC_set_line_color( short color )
{
    __QCS_FCONTEXT( "PDC_set_line_color" );
