...
{
	//--------------------------------------------------------------------------------
	class __QOR_INTERFACE( __WINQL ) CMonitorDevice : public CDeviceInterface
	{
	public:
	...
	private:
		...
		CMonitorDevice& operator = ( const CMonitorDevice& src );
		
	};

}//nsWin32

#endif//WINQL_DEVICE_MONITOR_H_3
