...
//Base CRT class for POSIX semaphore

#ifndef SYSTEMQOR_POSIX_SEMAPHORE_H_3
#define SYSTEMQOR_POSIX_SEMAPHORE_H_3
...
namespace nsBaseCRT
{
    ...
    //--------------------------------------------------------------------------------
    class __QOR_INTERFACE( __QSYS ) Csemaphore
    {
...
#endif//SYSTEMQOR_POSIX_SEMAPHORE_H_3
