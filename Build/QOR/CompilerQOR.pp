...
//Preprocessor build script generator for CompilerQOR.dll

#include "ModuleHeader.pph"

//Set CompilerQOR specific definitions and overrides

#define QOR_MODULE_NAME CompilerQOR

//Append the module specific PP defines to the list from the Operating System
#define QOR_CONFIG_DEFINES_COMPILERQOR1 QOR_PP_LIST_APPEND( QOR_CONFIG_DEFINES_OS,("__QCMP") )
#define QOR_CONFIG_DEFINES_COMPILERQOR2 QOR_PP_LIST_APPEND( QOR_CONFIG_DEFINES_COMPILERQOR1,("_LIBCPP_DLL") )
#define QOR_CONFIG_DEFINES_MODULE QOR_PP_LIST_APPEND( QOR_CONFIG_DEFINES_COMPILERQOR2,("") )
...
#define SOURCE_PATH ../../../Source/CompilerQOR/
#define SOURCES (CompilerQOR)
