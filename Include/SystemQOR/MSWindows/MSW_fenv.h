...
//MSWindows overrides for fenv

#ifndef SYSTEMQOR_MSW_FENV_H_3
#define SYSTEMQOR_MSW_FENV_H_3
...
{
	//--------------------------------------------------------------------------------
	class __QOR_INTERFACE( __QSYS ) Cfenv : public nsBaseCRT::Cfenv
	{
	public:
