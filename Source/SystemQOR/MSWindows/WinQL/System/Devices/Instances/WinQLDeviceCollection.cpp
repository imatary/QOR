...
//To implement a base class for interacting with device collections
...
namespace nsWin32
{
	...
	//--------------------------------------------------------------------------------
	CSetupAPIBase::CSetupAPIBase() : m_Library( CSetupAPI::Instance() )
	{
	}

	//--------------------------------------------------------------------------------
	CSetupAPIBase::CSetupAPIBase( const CSetupAPIBase& ) : m_Library( CSetupAPI::Instance() )
	{
	}
