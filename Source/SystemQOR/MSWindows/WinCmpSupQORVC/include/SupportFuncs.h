...
#ifndef WINCMPSUPVC_FUNCS_H_1
#define WINCMPSUPVC_FUNCS_H_1
...
extern "C" void _cdecl _ReadWriteBarrier( void );
#pragma intrinsic( _ReadWriteBarrier )

__forceinline long __sync_add_and_fetch( void volatile* plong, int i )
{
	if( i == 1 )
	{
		return _InterlockedIncrement( (long volatile*)plong );
	}
	else if( i == -1 )
	{
		return _InterlockedDecrement( (long volatile*)plong );
	}
	else
	{
		throw( "unsupported value for atomic operation" );
	}
}

//--------------------------------------------------------------------------------
template< typename T >
__forceinline T __sync_fetch_and_add( void volatile* /*plong*/, T )
{
	return 0;
}
...
//--------------------------------------------------------------------------------
template< typename T >
__forceinline T __sync_lock_test_and_set( void volatile* /*plong*/, T /*i*/ )
{
	return 0;
}

//--------------------------------------------------------------------------------
__forceinline bool __sync_bool_compare_and_swap( long volatile*, long, long )
{
	return 0;
}
