...
//Preprocessor build script generator for PosumQOR.dll

#include "ModuleHeader.pph"

//Set PosumQOR specific definitions and overrides

#define QOR_MODULE_NAME PosumQOR

//Append the module specific PP defines to the list from the Operating System
#define QOR_CONFIG_DEFINES_POSUMQOR1 QOR_PP_LIST_APPEND( QOR_CONFIG_DEFINES_OS,("__POSUMQOR") )
#define QOR_CONFIG_DEFINES_POSUMQOR2 QOR_PP_LIST_APPEND( QOR_CONFIG_DEFINES_POSUMQOR1,("_LIBCPP_DLL") )
#define QOR_CONFIG_DEFINES_MODULE QOR_PP_LIST_APPEND( QOR_CONFIG_DEFINES_POSUMQOR2,("") )
...
#define SOURCE_PATH ../../../Source/PosumQOR/
#define SOURCES	(PosumAsyncIOSession)\
				(PosumCharacter)\
				(PosumDescriptor)\
				(PosumLibraryLoader)\
				(PosumPath)\
