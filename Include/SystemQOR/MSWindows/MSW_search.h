...
//MSWindows overrides for search

#ifndef SYSTEMQOR_MSW_SEARCH_H_3
#define SYSTEMQOR_MSW_SEARCH_H_3
...
{
	//--------------------------------------------------------------------------------
	class __QOR_INTERFACE( __QSYS ) Csearch : public nsBaseCRT::Csearch
	{
	public:	
...
#endif//SYSTEMQOR_MSW_SEARCH_H_3
