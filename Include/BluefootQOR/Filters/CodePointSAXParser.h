...
#ifndef BLUEFOOT_FILTERS_CODEPOINTSAX_H_3
#define BLUEFOOT_FILTERS_CODEPOINTSAX_H_3

//Defines a filter encoding Unicode code points into SAX
...
namespace nsBluefoot
{
	...
	public:
		...
		CCodePointSAXParser();
		virtual ~CCodePointSAXParser();
		CCodePointSAXParser( const CCodePointSAXParser& src );
...
#endif//BLUEFOOT_FILTERS_CODEPOINTSAX_H_3
