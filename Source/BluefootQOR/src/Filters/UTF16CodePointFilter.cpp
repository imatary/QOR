...
{
	//------------------------------------------------------------------------------
	CUTF16CodePointFilter::CUTF16CodePointFilter() : CBFFilter()
	,	wcHigh( 0 )
	,	wcLow( 0 )
	,	m_bHigh( false )
	{
	...
	//------------------------------------------------------------------------------
	CUTF16CodePointFilter::CUTF16CodePointFilter( const CUTF16CodePointFilter& src ) : CBFFilter( src )
	{
		*this = src;
	}
	...
	//------------------------------------------------------------------------------
	CBFBuffer* CUTF16CodePointFilter::GetSourceBuffer( void )
	{
		return &m_SinkBuffer;
	}
