...
#ifndef SYSTEMQOR_LIN_SYS_RESOURCE_H_3
#define SYSTEMQOR_LIN_SYS_RESOURCE_H_3

#include "SystemQOR/Linux/types/sys/resource_types.h"
...
namespace nsLinux
{
	...
	//--------------------------------------------------------------------------------
	class __QOR_INTERFACE( __QSYS ) Cresource //: public nsBaseCRT::Caio
	{
	public:
...
#ifdef _GNU_SOURCE
        virtual int prlimit( pid_t, int, const rlimit*, rlimit* );
#endif
...
#endif//SYSTEMQOR_LIN_SYS_RESOURCE_H_3
