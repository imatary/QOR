//WinQLFrameScrollController.cpp
...
namespace nsWin32
{
	...
	//--------------------------------------------------------------------------------
	CFrameScrollController::~CFrameScrollController()
	{
		_WINQ_FCONTEXT( "CFrameScrollController::~CFrameScrollController" );
	}

	//--------------------------------------------------------------------------------
	void CFrameScrollController::OnVScroll( COSWindow& Window, Cmp_uint_ptr wParam, Cmp_long_ptr lParam )
	{
		_WINQ_FCONTEXT( "CFrameScrollController::OnVScroll" );
	}

	//--------------------------------------------------------------------------------
	void CFrameScrollController::OnHScroll( COSWindow& Window, Cmp_uint_ptr wParam, Cmp_long_ptr lParam )
	{
		_WINQ_FCONTEXT( "CFrameScrollController::OnHScroll" );
	}
