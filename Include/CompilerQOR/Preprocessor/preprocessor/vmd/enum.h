...
#if !defined(QOR_VMD_ENUM_H)
#define QOR_VMD_ENUM_H

#include "CompilerQOR/Preprocessor/preprocessor/vmd/detail/setup.h"

#if QOR_PP_VARIADICS

#include "CompilerQOR/Preprocessor/preprocessor/vmd/detail/sequence_enum.h"
...
/** \def QOR_VMD_ENUM(...)
    ...
    returns   = Comma-separated data, otherwise known as variadic data.
                ...
                optional return type other than QOR_VMD_RETURN_NO_TYPE
...
#define QOR_VMD_ENUM(...) \
    QOR_VMD_DETAIL_SEQUENCE_ENUM(__VA_ARGS__) \
/**/

/** \def QOR_VMD_ENUM_D(d,...)
...
#define QOR_VMD_ENUM_D(d,...) \
    QOR_VMD_DETAIL_SEQUENCE_ENUM_D(d,__VA_ARGS__) \
/**/

#endif /* QOR_PP_VARIADICS */
#endif /* QOR_VMD_ENUM_H */
