...
//Policy class for Qurses library 

#ifndef QURSES_POLICY_H_3
#define QURSES_POLICY_H_3
...
public:
	...
	__QCMP_STATIC_CONSTANT( unsigned long, DEFAULT_INITIAL_ARRAY_SIZE = 1 );
