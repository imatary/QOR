...
namespace nsWin32
{
	...
	__QOR_IMPLEMENT_OCLASS_LUID( CThreadResourceManager );

	//--------------------------------------------------------------------------------
	CThreadResourceManager::CThreadResourceManager( nsCodeQOR::CTCRef< CThread >& RefThread ) : m_RefThread( RefThread )
	{
	}
	...
	{
		return m_DeviceInfoSetHandleMap();
	}

	//--------------------------------------------------------------------------------
	CDeviceNotificationHandleMap& CThreadResourceManager::DeviceNotificationHandleMap( void )
	{
	...
	{
		return m_DeviceHandleMap();
	}
	*/

	//--------------------------------------------------------------------------------
	__QOR_IMPLEMENT_OCLASS_LUID( CResourceManager );

	//--------------------------------------------------------------------------------
	CResourceManager::CResourceManager()
	{
		_WINQ_FCONTEXT( "CResourceManager::CResourceManager" );
	}
