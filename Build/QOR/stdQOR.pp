...
//Preprocessor build script generator for stdQOR.dll

#include "ModuleHeader.pph"

//Set CompilerQOR specific definitions and overrides

#define QOR_MODULE_NAME stdQOR

//Append the module specific PP defines to the list from the Operating System
#define QOR_CONFIG_DEFINES_STDQOR1 QOR_PP_LIST_APPEND( QOR_CONFIG_DEFINES_OS,("cxx_EXPORTS") )
#define QOR_CONFIG_DEFINES_STDQOR2 QOR_PP_LIST_APPEND( QOR_CONFIG_DEFINES_STDQOR1,("_LIBCPP_DLL") )
#define QOR_CONFIG_DEFINES_STDQOR3 QOR_PP_LIST_APPEND( QOR_CONFIG_DEFINES_STDQOR2,("__STDQOR") )
#define QOR_CONFIG_DEFINES_MODULE QOR_PP_LIST_APPEND( QOR_CONFIG_DEFINES_STDQOR3,("") )
...
#define SOURCE_PATH ../../../Source/libcxx/src/
#define SOURCES (algorithm)\
				(bind)\
				(chrono)\
				(condition_variable)\
				(debug)\
...
#define SOURCE_PATH ../../../Source/stdQOR/
#define SOURCES (stdQOR)
#include "BuildQOR/BuildGroup.pph"
