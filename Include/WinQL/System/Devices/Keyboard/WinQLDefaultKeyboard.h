...
//Win32 Accessor object for default system keyboard
...
{
	//--------------------------------------------------------------------------------
	class __QOR_INTERFACE(__WINQL) CDefaultKeyboard
	{
	...
	private:
		...
		__QCS_DECLARE_NONCOPYABLE(CDefaultKeyboard);

	};

}//nsWin32

#endif//WINQL_DEVICE_DEFAULT_KEYBD_H_3
