...
#ifndef _UNITTEST_FUNCTIONIDX_H_
#define _UNITTEST_FUNCTIONIDX_H_
...
namespace nsUnitTesting
{
	...
	public:
		...
		__QCMP_STATIC_CONSTANT( unsigned int, VTABLE_INDEX_LIMIT		= 1024 );
	};

	//--------------------------------------------------------------------------------
	template< typename TMemberFunc > int GetFunctionIndex( TMemberFunc func ) 
	{
		func_index idx;
		return ( (&idx)->*reinterpret_cast< int (func_index::*)() >(func) )() * nsCompiler::CCompiler::VTABLE_FUNCTION_STRIDE + nsCompiler::CCompiler::VTABLE_FUNCTION_BASE;
	}

}// nsUnitTesting

#endif//_UNITTEST_FUNCTIONIDX_H_
