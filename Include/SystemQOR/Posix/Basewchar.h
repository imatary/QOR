...
//Base CRT class for wchar

#ifndef SYSTEMQOR_POSIX_WCHAR_H_3
#define SYSTEMQOR_POSIX_WCHAR_H_3
...
namespace nsBaseCRT
{
    ...
    using nsPlatform::mbstate_t;
    using nsPlatform::intptr_t;

    using nsPlatform::__utimbuf64;
    using nsPlatform::__utimbuf32;
    using nsPlatform::_stat32;
    using nsPlatform::_stat64;
	//using nsPlatform::__sstat64;
    using nsPlatform::_stat32i64;
    using nsPlatform::_stat64i32;

    using nsPlatform::FILE;
    using nsPlatform::va_list;
    using nsPlatform::tm;

	using nsPlatform::_wfinddata32_t;
	using nsPlatform::_wfinddata64_t;
	using nsPlatform::_wfinddata64i32_t;
	using nsPlatform::_wfinddata32i64_t;

	using nsPlatform::time_t;
	using nsPlatform::__time32_t;
	using nsPlatform::__time64_t;
	using nsPlatform::errno_t;
	using nsPlatform::locale_t;
	using nsPlatform::_locale_t;

	//--------------------------------------------------------------------------------
    class __QOR_INTERFACE( __QSYS ) Cwchar
    {
    public:
        ...
        virtual size_t wcsftime( wchar_t* s, size_t maxsize, const wchar_t* format, const tm* timeptr );
        ...
        virtual int wprintf_s( const wchar_t* __QCMP_RESTRICT format, va_list arg );
...
#endif//SYSTEMQOR_POSIX_WCHAR_H_3
