...
struct obex_transport_ops 
{
	...
	ssize_t (*write)(obex_t*, databuffer*);
...
int64_t obex_transport_get_timeout( obex *self);
void obex_transport_set_timeout( obex *self, int64_t timeout);
result_t obex_transport_handle_input( obex *self);
bool obex_transport_connect_request( obex *self);
void obex_transport_disconnect( obex *self);
bool obex_transport_listen( obex *self);
ssize_t obex_transport_write( obex *self, databuffer *msg);
ssize_t obex_transport_read( obex *self, int count);
void obex_transport_enumerate( obex *self);
void obex_transport_free_interfaces( obex *self);
int obex_transport_get_fd( obex *self);
