...
//Preprocessor build script generator for WinUsrExeBootWin.lib

#include "LibraryHeader.pph"

//Set WinUsrExeBootWin specific definitions and overrides
...
#define QOR_CONFIG_DEFINES_MODULE QOR_PP_LIST_APPEND( QOR_CONFIG_DEFINES_USESLIBCPP, ("_WINDOWS") )

#define QOR_LIB_NAME WinUsrExeBootWin
#define QOR_MODULE_NAME WinUsrExeBootWin
