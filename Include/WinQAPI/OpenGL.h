...
{
	//--------------------------------------------------------------------------------
	class __QOR_INTERFACE( __WINQAPI ) COpenGL32 : public CDll
	{
	public:

		//--------------------------------------------------------------------------------
		COpenGL32() : CDll( TEXT("OpenGL32.dll") )
		{						
		}

		//--------------------------------------------------------------------------------
		static COpenGL32& Instance( void )
		{
			static COpenGL32 _instance;
			return _instance;
		}
		...
		void glRasterPos2dv( const GLint* v );
		...
		void glGetColorTableEXT( GLenum target, GLenum format, GLenum type, const GLvoid* data );
		...
		void glMultMatrixf( const GLdouble* m );
