...
//MSWindows overrides for dlfcn

#ifndef SYSTEMQOR_MSW_DLFCN_H_3
#define SYSTEMQOR_MSW_DLFCN_H_3
...
namespace nsWin32
{
	...
	private:
		...
		nsWinPosum::CLibraryLoader m_LibraryLoader;
