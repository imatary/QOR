...
//Win32 Device Manager Controller hierarchy, Enumerator for Device Setup Classes

#ifndef WINQL_DEVICEMANAGERCONTROLLERSETUPENUMERATOR_H_3
#define WINQL_DEVICEMANAGERCONTROLLERSETUPENUMERATOR_H_3
...
namespace nsWin32
{
	...
	public:
		...
		__QOR_DECLARE_OCLASS_ID( CDeviceSetupClassEnumerator );

		CDeviceSetupClassEnumerator();
		CDeviceSetupClassEnumerator( const CDeviceSetupClassEnumerator& src );
		CDeviceSetupClassEnumerator& operator = ( const CDeviceSetupClassEnumerator& src );
		virtual ~CDeviceSetupClassEnumerator();
		void Enumerate( void );
	};

}//nsWin32

#endif//WINQL_DEVICEMANAGERCONTROLLERSETUPENUMERATOR_H_3
