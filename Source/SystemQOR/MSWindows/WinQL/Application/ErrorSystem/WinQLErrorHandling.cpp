...
namespace nsWin32
{
	...
	//--------------------------------------------------------------------------------
	void CErrorHelper::FatalAppExitT( unsigned int uAction, const TCHAR* lpMessageText )
	{
		_WINQ_SFCONTEXT( "CErrorHelper::FatalAppExit" );
		__QOR_PROTECT
		{
			CKernel32::FatalAppExit( uAction, lpMessageText );
		}__QOR_ENDPROTECT
	}
	...
	//--------------------------------------------------------------------------------
	void CErrorHelper::SetLastError( unsigned long dwErrCode )
	{
		_WINQ_FCONTEXT( "CErrorHelper::SetLastError" );
		__QOR_PROTECT
		{
			CKernel32::SetLastError( dwErrCode );
		}__QOR_ENDPROTECT
	}
	/*
	//--------------------------------------------------------------------------------
	bool CErrorHelper::MessageBeep( unsigned int uiType )
	{
		_WINQ_FCONTEXT( "CErrorHelper::MessageBeep" );
		bool bResult = false;
		__QOR_PROTECT
		{
			bResult = m_User32Library.MessageBeep( uiType ) ? true : false;
		}__QOR_ENDPROTECT
		return bResult;
	}
	*/
