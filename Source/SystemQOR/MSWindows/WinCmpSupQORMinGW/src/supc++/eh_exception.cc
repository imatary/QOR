...
std::exception::~exception() __QCMP_USE_NOEXCEPT { }

/*TODO:: bad_exception
std::bad_exception::~bad_exception() __QCMP_USE_NOEXCEPT { }
*/
...
const char* 
std::exception::what() const __QCMP_USE_NOEXCEPT
{
...
/*TODO:: bad_exception
const char* 
std::bad_exception::what() const __QCMP_USE_NOEXCEPT
{
