...
//Base CRT class for Csignal

#ifndef SYSTEMQOR_POSIX_SIGNAL_H_3
#define SYSTEMQOR_POSIX_SIGNAL_H_3
...
namespace nsBaseCRT
{
	...
	using nsPlatform::sigaction;
	using nsPlatform::stack_t;
	using nsPlatform::timespec;
	using nsPlatform::sigval;
	using nsPlatform::psig_func;

	//--------------------------------------------------------------------------------
	class __QOR_INTERFACE( __QSYS ) Csignal
	{
	
	public:

		__QOR_DECLARE_OCLASS_ID( Csignal );

		virtual void signal( int sig, psig_func );//( *signal( int sig, void (*func)( int ) ) )( int );
		...
		virtual int sigqueue( pid_t, int, const sigval );
		virtual int sigrelse( int );
		virtual void sigset( int, psig_func );//( *sigset(int, void (*)( int ) ) )( int );
...
#endif//SYSTEMQOR_POSIX_SIGNAL_H_3
