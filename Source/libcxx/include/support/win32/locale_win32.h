...
//ctype mask table defined in WinQL.dll
//unsigned short __declspec(dllimport) nsWin32::CharData::sc_usCType[];
...
inline int isblank_l( int c, locale_t  )
{
    return ( c == ' ' || c == '\t' );
}
inline int iswblank_l( wint_t c, locale_t  )
{
    return ( c == L' ' || c == L'\t' );
}

#if defined(_LIBCPP_MSVCRT)
inline int isblank( int c, locale_t  )
{ return ( c == ' ' || c == '\t' ); }
inline int iswblank( wint_t c, locale_t  )
{ return ( c == L' ' || c == L'\t' ); }
