...
#include "PosumQOR/Linux/LinLibraryLoader.h"
#include "PosumQOR/Linux/LinPath.h"
...
__QCMP_WARNING_POP
	...
	{
		nsLinPosum::CSharedLibrary* pLinLibrary = dynamic_cast< nsLinPosum::CSharedLibrary* >( pLibrary );
		if( pLinLibrary )
		{
			return pLinLibrary->Close();
		}
	...
	CSharedLibrary* CLibraryLoader::Open( CPath& Path, int iMode )
	{
		...
		nsLinPosum::CSharedLibrary* pNewLinLibrary = new CSharedLibrary( strPath, iMode );
		return pNewLinLibrary;
	}
