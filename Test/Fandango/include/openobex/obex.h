...
typedef void (*obex_event_t)(obex_t *handle, CObexObject* obj, int mode, int event, int obex_cmd, int obex_rsp);
...
OPENOBEX_SYMBOL(obex_data_direction) OBEX_GetDataDirection(obex_t *self);
...
OPENOBEX_SYMBOL(int) OBEX_Request(obex_t *self, CObexObject* object);
OPENOBEX_SYMBOL(int) OBEX_CancelRequest(obex_t *self, int nice);
OPENOBEX_SYMBOL(int) OBEX_SuspendRequest(obex_t *self, CObexObject* object);
OPENOBEX_SYMBOL(int) OBEX_ResumeRequest(obex_t *self);

OPENOBEX_SYMBOL(CObexObject*) OBEX_ObjectNew(obex_t *self, uint8_t cmd);
OPENOBEX_SYMBOL(int)             OBEX_ObjectDelete(obex_t *self, CObexObject* object);
OPENOBEX_SYMBOL(int)             OBEX_ObjectGetSpace(obex_t *self, CObexObject* object, unsigned int flags);

OPENOBEX_SYMBOL(void) OBEX_SetReponseMode(obex_t *self, obex_rsp_mode rsp_mode);

OPENOBEX_SYMBOL(int) OBEX_ObjectAddHeader(obex_t *self, CObexObject* object, uint8_t hi, obex_headerdata_t hv, uint32_t hv_size, unsigned int flags);
OPENOBEX_SYMBOL(int) OBEX_ObjectGetNextHeader(obex_t *self, CObexObject* object, uint8_t *hi, obex_headerdata_t *hv, uint32_t *hv_size);
OPENOBEX_SYMBOL(int) OBEX_ObjectReParseHeaders(obex_t *self, CObexObject* object);
OPENOBEX_SYMBOL(int) OBEX_ObjectSetRsp(CObexObject* object, uint8_t rsp, uint8_t lastrsp);

OPENOBEX_SYMBOL(int) OBEX_ObjectGetNonHdrData(CObexObject* object, uint8_t **buffer);
OPENOBEX_SYMBOL(int) OBEX_ObjectSetNonHdrData(CObexObject* object, const uint8_t *buffer, unsigned int len);
OPENOBEX_SYMBOL(int) OBEX_ObjectSetHdrOffset(CObexObject* object, unsigned int offset);
OPENOBEX_SYMBOL(int) OBEX_ObjectReadStream(obex_t *self, CObexObject* object, const uint8_t **buf);
OPENOBEX_SYMBOL(int) OBEX_ObjectGetCommand(obex_t *self, CObexObject* object);
