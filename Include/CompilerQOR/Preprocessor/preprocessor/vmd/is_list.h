...
#if !defined(QOR_VMD_IS_LIST_H)
#define QOR_VMD_IS_LIST_H
...
/** \def QOR_VMD_IS_LIST(sequence)
    ...
    as in the example '(anything,&QOR_PP_NIL)' which is a valid tuple but
    an invalid list.
    
*/

#define QOR_VMD_IS_LIST(sequence) \
    QOR_VMD_DETAIL_IS_LIST(sequence) \
/**/

/** \def QOR_VMD_IS_LIST_D(d,sequence)
...
#define QOR_VMD_IS_LIST_D(d,sequence) \
    QOR_VMD_DETAIL_IS_LIST_D(d,sequence) \
/**/

#endif /* QOR_PP_VARIADICS */
#endif /* QOR_VMD_IS_LIST_H */
