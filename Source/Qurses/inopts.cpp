...
void noqiflush( void )
{
    __QCS_FCONTEXT( "noqiflush" );
}

//------------------------------------------------------------------------------
void qiflush( void )
{
    __QCS_FCONTEXT( "qiflush" );
}

//------------------------------------------------------------------------------
int typeahead( int fildes )
{
    __QCS_FCONTEXT( "typeahead" );
...
void wtimeout( WINDOW* win, int delay )
{
    ...
    {
        // This causes the read on the window to delay for the number of milliseconds. Also forces the window into non-blocking read mode
