...
namespace nsBaseCRT
{
	__QOR_IMPLEMENT_OCLASS_LUID(Cdlfcn);
	...
	//--------------------------------------------------------------------------------
    void* Cdlfcn::dlopen( const char*, int )
	{
	...
	//--------------------------------------------------------------------------------
    void* Cdlfcn::dlsym( void* __QCMP_RESTRICT, const char* __QCMP_RESTRICT )
	{
