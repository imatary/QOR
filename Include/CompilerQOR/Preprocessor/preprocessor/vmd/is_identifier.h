...
#if !defined(QOR_VMD_IS_IDENTIFIER_H)
#define QOR_VMD_IS_IDENTIFIER_H
...
#define QOR_VMD_IS_IDENTIFIER(...) \
    QOR_VMD_DETAIL_IS_IDENTIFIER(__VA_ARGS__) \
/**/

/** \def QOR_VMD_IS_IDENTIFIER_D(d,...)
...
#define QOR_VMD_IS_IDENTIFIER_D(d,...) \
    QOR_VMD_DETAIL_IS_IDENTIFIER_D(d,__VA_ARGS__) \
/**/

#endif /* QOR_PP_VARIADICS */
#endif /* QOR_VMD_IS_IDENTIFIER_H */
