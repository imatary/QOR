...
const locale::category locale::collate = LC_COLLATE_MASK;
const locale::category locale::ctype = LC_CTYPE_MASK;
const locale::category locale::monetary = LC_MONETARY_MASK;
const locale::category locale::numeric = LC_NUMERIC_MASK;
const locale::category locale::time = LC_TIME_MASK;
const locale::category locale::messages = LC_MESSAGES_MASK;
const locale::category locale::all = collate | ctype | monetary | numeric | time | messages;
...
const ctype_base::mask ctype_base::space = 0x8;
const ctype_base::mask ctype_base::print = 0x40 | 0x10 | 0x103 | 0x4;
const ctype_base::mask ctype_base::cntrl = 0x20;
const ctype_base::mask ctype_base::upper = 0x1;
const ctype_base::mask ctype_base::lower = 0x2;
const ctype_base::mask ctype_base::alpha = 0x103;
const ctype_base::mask ctype_base::digit = 0x4;
const ctype_base::mask ctype_base::punct = 0x10;
const ctype_base::mask ctype_base::xdigit = 0x80;
const ctype_base::mask ctype_base::blank = 0x40;
const ctype_base::mask ctype_base::alnum = alpha | digit;
const ctype_base::mask ctype_base::graph = alnum | punct;
...
ctype<char>::classic_table()  _NOEXCEPT
{
	...
	return nsWin32::CharData::getCType() + 1;// _ctype + 1; // internal ctype mask table defined in msvcrt.dll
                                   ...
                                   const ios_base& __iob)
{
	...
	case 0x0010://ios_base::internal:
        ...
        if (__ne - __nb >= 2 && __nb[0] == '0'
            ...
            return __nb+2;
        break;
	case 0x0020://ios_base::left:
        return __ne;
	case 0x0080://ios_base::right:
    default:
        break;
    }
    return __nb;
