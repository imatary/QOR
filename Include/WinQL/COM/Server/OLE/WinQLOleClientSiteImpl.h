...
#ifndef WINQL_COM_OLECLIENTSITEIMPL_H_3
#define WINQL_COM_OLECLIENTSITEIMPL_H_3
...
{
	//--------------------------------------------------------------------------------
	class __QOR_INTERFACE( __WINQL_COM ) COleClientSiteImpl : public CInterfaceImplBase< IOleClientSite >
	{
	public:

		__QOR_DECLARE_COMCLASS_ID( COleClientSiteImpl );

		COleClientSiteImpl( CIUnknownImplBase<>* pImpl );
		virtual ~COleClientSiteImpl();
	...
	private:
		...
		COleClientSiteImpl();
		COleClientSiteImpl( const COleClientSiteImpl& );
		COleClientSiteImpl& operator = ( const COleClientSiteImpl& );
	};

}//nsWin32

#endif//WINQL_COM_OLECLIENTSITEIMPL_H_3
