...
{
	__QCS_FCONTEXT( "_panels_overlapped" );
...
{
	__QCS_FCONTEXT( "_panel_is_linked" );
...
{
	__QCS_FCONTEXT( "_panel_link_top" );
...
int set_panel_userptr( PANEL* pan, const void* uptr )
{
	__QCS_FCONTEXT( "set_panel_userptr" );
