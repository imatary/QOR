...
namespace nsUnitTesting
{
	...
	{
		static CUnitTestCollection g_UnitTests;
		static CUnitTestCollection* pUnitTests = &g_UnitTests;

		if( pUnitTestCollection != (CUnitTestCollection*)-1 )
		{
			pUnitTests = pUnitTestCollection;
		}
