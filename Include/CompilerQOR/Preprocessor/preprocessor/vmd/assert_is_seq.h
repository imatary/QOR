...
#if !defined(QOR_VMD_ASSERT_IS_SEQ_H)
#define QOR_VMD_ASSERT_IS_SEQ_H
...
/** \def QOR_VMD_ASSERT_IS_SEQ(sequence)
...
/** \def QOR_VMD_ASSERT_IS_SEQ_D(d,sequence)
...
#define QOR_VMD_ASSERT_IS_SEQ(sequence)
#define QOR_VMD_ASSERT_IS_SEQ_D(d,sequence)
...
#define QOR_VMD_ASSERT_IS_SEQ(sequence) \
    QOR_VMD_ASSERT \
      ( \
      QOR_VMD_IS_SEQ(sequence), \
      QOR_VMD_ASSERT_IS_SEQ_ERROR \
      ) \
/**/
