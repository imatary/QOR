...
#if !defined(QOR_VMD_TO_TUPLE_H)
#define QOR_VMD_TO_TUPLE_H
...
#define QOR_VMD_TO_TUPLE(...) \
    QOR_VMD_DETAIL_SEQUENCE_TO_TUPLE(__VA_ARGS__) \
/**/

/** \def QOR_VMD_TO_TUPLE_D(d,...)
