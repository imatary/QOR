...
//The Appocrita controller library
//A batch process controller
//A background worker controller
//A terminal application controller
//A GUI application controller


//A controller will need an initial default model type with which to work. 
//It will need to determine the correct workflow from the process parameters
//It will need to carry out the workflow creating child controllers, views and additional models as required
...
//Policy class for AppocritaQOR library 

#ifndef APPOCRITA_POLICY_H_3
#define APPOCRITA_POLICY_H_3

#ifndef __QOR_MODULE_POLICY
#define __QOR_MODULE_POLICY
...
#endif //__QOR_MODULE_POLICY
#endif//APPOCRITA_POLICY_H_3
