...
#ifndef SYSTEMQOR_WINDOWS_H_1
#define SYSTEMQOR_WINDOWS_H_1
...
//The Windows Runtime becomes the Operating System Runtime 
//as the nsWin32 namespace is used as the generic nsOSRT namespace
#define nsOSRT nsWin32
