...
#include "WinQL/System/Devices/Ports/WinQLSerialBusEnumerator.h"
...
namespace nsWin32
{
	__QOR_IMPLEMENT_OCLASS_GUID( CSerialBusEnumerator, 0x4D36E978, 0xE325, 0x11CE, 0xBF, 0xC1, 0x08, 0x00, 0x2B, 0xE1, 0x03, 0x18 );
	
	nsCodeQOR::CTExternalRegEntry< CSerialBusEnumerator > CSerialBusEnumerator::RegEntry;

	//--------------------------------------------------------------------------------
	CSerialBusEnumerator::CSerialBusEnumerator() : CDeviceInterface()
	{
		_WINQ_FCONTEXT( "CSerialBusEnumerator::CSerialBusEnumerator" );
	}

	//--------------------------------------------------------------------------------
	CSerialBusEnumerator::~CSerialBusEnumerator()
	{
		_WINQ_FCONTEXT( "CSerialBusEnumerator::~CSerialBusEnumerator" );
	}
