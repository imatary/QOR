...
static void obex_event_cb(obex_t *handle, obex_object_t *obj, int mode, int event, int obex_cmd, int obex_rsp)
{
}

static int match_usb_interface(obex_usb_intf_t *intf, uint16_t vendor, uint16_t product)
{
