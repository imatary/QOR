...
#ifndef WINQL_IO_MAILSLOTSOURCE_H_3
#define WINQL_IO_MAILSLOTSOURCE_H_3
...
namespace nsWin32
{
	...
	//--------------------------------------------------------------------------------
	//A general Bluefoot source which reads from a Win32 MailSlot connection
	class __QOR_INTERFACE( __WINQL ) CMailSlotSource : public CIOSource
	{
	public:

		__QOR_DECLARE_OCLASS_ID( CMailSlotSource );

		CMailSlotSource( CMailSlotConnector* pPipeConnector );
...
#endif//WINQL_IO_MAILSLOTSOURCE_H_3
