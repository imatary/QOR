...
#if !defined( QOR_VMD_ASSERT_IS_TUPLE_H )
#define QOR_VMD_ASSERT_IS_TUPLE_H
...
/** \def QOR_VMD_ASSERT_IS_TUPLE(sequence)
...
#	define QOR_VMD_ASSERT_IS_TUPLE( sequence )
...
#	define QOR_VMD_ASSERT_IS_TUPLE( sequence )                                                                        \
	QOR_VMD_ASSERT( QOR_VMD_IS_TUPLE( sequence ), QOR_VMD_ASSERT_IS_TUPLE_ERROR ) \
/**/

#endif /* QOR_VMD_ASSERT_DATA */

#endif /* QOR_PP_VARIADICS */
#endif /* QOR_VMD_ASSERT_IS_TUPLE_H */
