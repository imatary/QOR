...
namespace nsBaseCRT
{
    ...
    //------------------------------------------------------------------------------
    double Cmath::jn( int n, double x )
    {
        return (double)jnf( n, (float)x );
    }

    //------------------------------------------------------------------------------
    double Cmath::yn( int n, double x )
    {
    ...
    //------------------------------------------------------------------------------
    double Cmath::__ieee754_jn( int n, double x )
    {
        ...
        Cmp_signed__int32 i, hx, ix, lx, sgn;
        double a;
        double b;
        double temp = 0;
        double di;
        ...
        ix = 0x7fffffff & hx;
        // if J(n,NaN) is NaN
        if( ( ix | ( (Cmp_unsigned__int32)( lx | -lx ) ) >> 31 ) > 0x7ff00000 )
        {
            return x + x;
        }
        if( n < 0 )
    ...
    //------------------------------------------------------------------------------
    double Cmath::__ieee754_yn( int n, double x )
    {
        static const double invsqrtpi = 5.64189583547756279280e-01; // 0x3FE20DD7, 0x50429B6D
        static const double one  =  1.00000000000000000000e+00; // 0x3FF00000, 0x00000000
        static const double zero =  0.00000000000000000000e+00;

        Cmp_signed__int32 i, hx, ix, lx;
    ...
    //------------------------------------------------------------------------------
    float Cmath::__ieee754_jnf( int n, float x )
    {
    ...
    //------------------------------------------------------------------------------
    float Cmath::__ieee754_ynf( int n, float x )
    {
        static const float one =  1.0000000000e+00; // 0x3F800000
        static const float zero =  0.0000000000e+00;

        Cmp_signed__int32 i, hx, ix, ib;
        Cmp_signed__int32 sign;
        float a, b, temp;
