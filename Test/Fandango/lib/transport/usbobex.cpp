 ...
 */
static void find_eps(struct obex_usb_intf_transport_t *intf, usb_interface_descriptor data_intf, int *found_active, int *found_idle)
{
	if (data_intf.bNumEndpoints == 2) 
	{
		usb_endpoint_descriptor *ep0, *ep1;
 ...
 * Helper function to usbobex_find_interfaces
 */
static int find_obex_data_interface(unsigned char *buffer, int buflen, usb_config_descriptor config, struct obex_usb_intf_transport_t *intf)
{
 ...
 * Helper function to usbobex_find_interfaces
 */
static int get_intf_string( usb_dev_handle* usb_handle, char **string, int id)
{
	if (id) {
 ...
 * Helper function to usbobex_find_interfaces
 */
static struct obex_usb_intf_transport_t *check_intf( usb_device* dev, int c, int i, int a)
{
