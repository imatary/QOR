...
#ifndef SYSTEMQOR_MSW_SYS_RESOURCE_H_3
#define SYSTEMQOR_MSW_SYS_RESOURCE_H_3
...
{
	//--------------------------------------------------------------------------------
	class __QOR_INTERFACE( __QSYS ) Cresource : public nsBaseCRT::Cresource
	{
	public:	
...
#endif//SYSTEMQOR_MSW_SYS_RESOURCE_H_3
