...
namespace nsWin32
{
	...
	CThread::CThread() : m_pCRTThreadData( 0 ), m_pResourceManager( 0 )
	{
	...
	{
		_WINQ_FCONTEXT( "CThread::~CThread" );
		t_pCurrentWin32Thread = 0;		//No longer any thread object on this thread.
	...
	mxTCHAR* CThread::Name( void )
	{
		...
		{
			return const_cast< mxTCHAR* >( _TXT( "unnamed" ).c_str() );
		}
	}
