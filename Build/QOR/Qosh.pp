...
//Preprocessor build script generator for Qosh.exe

#include "ModuleHeader.pph"

//Set Qosh specific definitions and overrides
...
#define SOURCE_PATH ../../../Test/Qosh/src/
#define SOURCES (args)\
				(blok)\
				(bltin)\
				(cmd)\
...
#define QOR_LIB_PATHS (..\..\..\Build\%build_project%\%build_architecture%\%build_os%\%build_os_ver%\%build_form%\%build_config%\%buildtype%)
