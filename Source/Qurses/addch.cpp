...
/*man-start**************************************************************
  ...
  Description:
        ...
        (define __QOR_UNICODE = 1). So, in functions that take a chtype, like
