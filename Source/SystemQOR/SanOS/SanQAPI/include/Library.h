...
#ifndef SANQAPI_LIB_H_1
#define SANQAPI_LIB_H_1

#include "CodeQOR/ErrorSystem/Error.h"
//#include "../SystemQOR/SanOS/SanQAPI/include/ErrorDomain.h"
...
namespace nsSanQAPI
{
	...
	//------------------------------------------------------------------------------
	class __QOR_INTERFACE( __SANQAPI ) CLibrary
	{
	public:
