...
#include <fmtmsg.h>
#include <errno.h>
#include QOR_SYS_PLATFORMHEADER(fmtmsg.h)
...
{
    __QCS_FCONTEXT( "fmtmsg" );
    int iResult = 0;
    __QCS_PROTECT
    {
		nsPlatform::Cfmtmsg _fmtmsg;
        iResult = _fmtmsg.fmtmsg( classification, label, severity, text, action, tag );
    }__QCS_ENDPROTECT
    return iResult;
}
