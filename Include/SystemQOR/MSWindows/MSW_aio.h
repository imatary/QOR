...
//MSWindows overrides for aio

#ifndef SYSTEMQOR_MSW_AIO_H_3
#define SYSTEMQOR_MSW_AIO_H_3
...
{
	//--------------------------------------------------------------------------------
	class __QOR_INTERFACE( __QSYS ) Caio : public nsBaseCRT::Caio
	{
	public:	
		...
		virtual int lio_listio(int, aiocb* __QCMP_RESTRICT const[/*__QCMP_RESTRICT*/], int, sigevent* __QCMP_RESTRICT);
