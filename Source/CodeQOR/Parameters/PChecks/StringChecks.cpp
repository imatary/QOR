...
{
	//--------------------------------------------------------------------------------
	//String parameter check implementations

    //--------------------------------------------------------------------------------
    void CStringCheck::Check( const mxTCHAR* __QCS_UNUSED( pwsz ) )
    {
#pragma TODO( "String validation check" )
    }

    //--------------------------------------------------------------------------------
    void CASCIIStringCheck::Check( const char* __QCS_UNUSED( psz ) )
    {
#pragma TODO( "ASCII string validation check" )
    }
