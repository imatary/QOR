...
//MSWindows overrides for pwd

#ifndef SYSTEMQOR_MSW_PWD_H_3
#define SYSTEMQOR_MSW_PWD_H_3
...
{
	//--------------------------------------------------------------------------------
	class __QOR_INTERFACE( __QSYS ) Cpwd : public nsBaseCRT::Cpwd
	{
	public:	
