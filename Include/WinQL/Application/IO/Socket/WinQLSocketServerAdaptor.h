...
{
	//--------------------------------------------------------------------------------
	//Adapt a general SocketConnector for use as a connection on the server side
	class __QOR_INTERFACE( __WINQL ) CSocketServerAdaptor : public CSocketConnector
	{
	public:
		...
		//Socket server connection properties
		void SetBacklog( int iBacklog );
		int GetBacklog( void );
...
#endif//WINQL_IO_SOCKETSERVERADAPTOR_H_3
