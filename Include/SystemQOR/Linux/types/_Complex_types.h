...
#if __STDC_VERSION__ >= 201112L
#	if defined(_Imaginary_I)
typedef long double long_double_complex;
typedef double double_complex;
typedef float float_complex;
#	elif defined(__clang__)
typedef _Complex long double long_double_complex;
typedef _Complex double double_complex;
typedef _Complex float flost_complex;
#	else
typedef __builtin_complex( long double ) long_double_complex;
typedef __builtin_complex( double ) double_complex;
typedef __builtin_complex( float ) float_complex;
#	endif
#else
