...
#define DUMPVER 1   // Should be updated whenever the WINDOW struct is changed

//------------------------------------------------------------------------------
int putwin( WINDOW* win, FILE* filep )
{
	__QCS_FCONTEXT( "putwin" );
