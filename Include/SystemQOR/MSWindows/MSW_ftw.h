...
//MSWindows overrides for ftw

#ifndef SYSTEMQOR_MSW_FTW_H_3
#define SYSTEMQOR_MSW_FTW_H_3
...
{
	//--------------------------------------------------------------------------------
	class __QOR_INTERFACE( __QSYS ) Cftw : public nsBaseCRT::Cftw
	{
	public:	
