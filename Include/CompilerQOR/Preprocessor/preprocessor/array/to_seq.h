...
#
#define QOR_PP_ARRAY_TO_SEQ( array )                                                                                   \
	QOR_PP_IF( QOR_PP_ARRAY_SIZE( array ), QOR_PP_ARRAY_TO_SEQ_DO, QOR_PP_ARRAY_TO_SEQ_EMPTY )                         \
	( array ) \
/**/
#define QOR_PP_ARRAY_TO_SEQ_EMPTY( array )
#
#if QOR_PP_CONFIG_FLAGS() & QOR_PP_CONFIG_MSVC()
#define QOR_PP_ARRAY_TO_SEQ_DO( array ) QOR_PP_ARRAY_TO_SEQ_I( QOR_PP_TUPLE_TO_SEQ, array )
...
#define QOR_PP_ARRAY_TO_SEQ_DO( array ) QOR_PP_ARRAY_TO_SEQ_I( array )
#define QOR_PP_ARRAY_TO_SEQ_I( array ) QOR_PP_TUPLE_TO_SEQ##array
#else
#define QOR_PP_ARRAY_TO_SEQ_DO( array ) QOR_PP_TUPLE_TO_SEQ array
#endif
