...
//Implement x86 Instruction Set Extension base
...
namespace nsArch
{
	...
	{
		//------------------------------------------------------------------------------
		Cx86ISetExtension::Cx86ISetExtension( Cx86CPUCore& refCPU ) : CISetExtension(), m_PU( refCPU )
		{
		}

		//------------------------------------------------------------------------------
		Cx86ISetExtension::~Cx86ISetExtension()
		{
		}
	}
}
