...
{
	//--------------------------------------------------------------------------------
	class __QOR_INTERFACE( __WINQL ) CUser
	{
	public:
	...
	private:
		...
		CGeoLocationHelper m_GeoLocationHelper;
		CLocaleHelper m_LocaleHelper;
	};

}//nsWin32

#endif//WINQL_SYSTEM_USER_H_3
