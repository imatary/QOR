...
d:\tools\LLVM\bin\clang-cl.exe /c /I"%build_shell_path%" /I"..\..\..\include\BuildQOR\Cmd" /I"..\..\..\include\CompilerQOR\Compilers\clang" /I"..\..\..\include" %build_env_params% /W0 /nologo /X /P /EP %1.pp > %1.i
