...
//Preprocessor build script generator for Winner.exe

#include "ModuleHeader.pph"

//Set Winner specific definitions and overrides
...
#define SOURCE_PATH ../../../Test/Windows/Winner/
#define SOURCES (Winner)
