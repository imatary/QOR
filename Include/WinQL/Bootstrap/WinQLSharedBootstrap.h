...
//Defines a Windows specific bootstrap object for Dlls

#ifndef WINQL_SHAREDBOOTSTRAP_H_1
#define WINQL_SHAREDBOOTSTRAP_H_1
...
{
	//--------------------------------------------------------------------------------
	class __QOR_INTERFACE( __WINQL ) CSharedBootStrap : public CModuleBootStrap
	{
	public:
...
#endif//WINQL_SHAREDBOOTSTRAP_H_1
