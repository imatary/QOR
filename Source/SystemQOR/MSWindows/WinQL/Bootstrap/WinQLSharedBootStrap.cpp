...
#include "SystemQOR.h"
#include "WinQL/Bootstrap/WinQLSharedBootStrap.h"
...
namespace nsWin32
{
	...
	CSharedBootStrap::CSharedBootStrap( void* hModule ) : CModuleBootStrap()
	{
		m_iProcAttached = 0;	
		m_hModule = hModule;
	}
	...
	int CSharedBootStrap::ProcessAttach()
	{
	...
	int CSharedBootStrap::ProcessDetach()
	{
		return --m_iProcAttached;
	}
	...
	bool CSharedBootStrap::ProcessAttached()
	{
		return m_iProcAttached > 0 ? true : false;
	}

	//--------------------------------------------------------------------------------
	void* CSharedBootStrap::InstanceHandle( void )
	{
		return m_hModule;
	}
