...
//MSWindows overrides for utmpx

#ifndef SYSTEMQOR_MSW_UTMPX_H_
#define SYSTEMQOR_MSW_UTMPX_H_
...
{
	//--------------------------------------------------------------------------------
	class __QOR_INTERFACE( __QSYS ) Cutmpx : public nsBaseCRT::Cutmpx
	{
	public:
