...
//MSWindows overrides for ctype

#ifndef SYSTEMQOR_MSW_CTYPE_H_3
#define SYSTEMQOR_MSW_CTYPE_H_3
...
{
	//--------------------------------------------------------------------------------
	class __QOR_INTERFACE( __QSYS ) Cctype : public nsBaseCRT::Cctype
	{		
	public:
