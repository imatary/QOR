...
#if !defined(QOR_VMD_DETAIL_SEQUENCE_TO_SEQ_H)
#define QOR_VMD_DETAIL_SEQUENCE_TO_SEQ_H
...
#define QOR_VMD_DETAIL_SEQUENCE_TO_SEQ(...) \
    QOR_PP_EXPR_IIF \
        ( \
...
#define QOR_VMD_DETAIL_SEQUENCE_TO_SEQ_D(d,...) \
    QOR_PP_EXPR_IIF \
        ( \
        QOR_VMD_DETAIL_NOT_EMPTY(QOR_VMD_DETAIL_SEQUENCE_ELEM_GET_VSEQ(__VA_ARGS__)), \
...
#endif /* QOR_VMD_DETAIL_SEQUENCE_TO_SEQ_H */
