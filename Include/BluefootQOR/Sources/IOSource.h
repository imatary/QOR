...
#ifndef BLUEFOOT_SOURCES_IOSOURCE_H_3
#define BLUEFOOT_SOURCES_IOSOURCE_H_3
...
//Defines an IOSource for a Bluefoot pipeline
...
#endif//BLUEFOOT_SOURCES_IOSOURCE_H_3
