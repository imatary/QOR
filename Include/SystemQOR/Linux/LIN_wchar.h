...
//Linux overrides for wchar

#ifndef SYSTEMQOR_LIN_WCHAR_H_3
#define SYSTEMQOR_LIN_WCHAR_H_3

#include "SystemQOR/Linux/types/wchar_types.h"
#include "SystemQOR/Linux/types/uchar_types.h"
...
{
	//--------------------------------------------------------------------------------
	class __QOR_INTERFACE( __QSYS ) Cwchar //: public nsBaseCRT::Cregex
	{
	public:
		...
		virtual wchar_t *wcscpy (wchar_t *__restrict, const wchar_t *__restrict);
		virtual wchar_t *wcsncpy (wchar_t *__restrict, const wchar_t *__restrict, size_t);

		virtual wchar_t *wcscat (wchar_t *__restrict, const wchar_t *__restrict);
		virtual wchar_t *wcsncat (wchar_t *__restrict, const wchar_t *__restrict, size_t);

		virtual int wcscmp (const wchar_t *, const wchar_t *);
		virtual int wcsncmp (const wchar_t *, const wchar_t *, size_t);

		virtual int wcscoll(const wchar_t *, const wchar_t *);
		virtual size_t wcsxfrm (wchar_t *__restrict, const wchar_t *__restrict, size_t n);

		virtual wchar_t *wcschr (const wchar_t *, wchar_t);
		virtual wchar_t *wcsrchr (const wchar_t *, wchar_t);

		virtual size_t wcscspn (const wchar_t *, const wchar_t *);
		virtual size_t wcsspn (const wchar_t *, const wchar_t *);
		virtual wchar_t *wcspbrk (const wchar_t *, const wchar_t *);

		virtual wchar_t *wcstok (wchar_t *__restrict, const wchar_t *__restrict, wchar_t **__restrict);

		virtual size_t wcslen (const wchar_t *);

		virtual wchar_t *wcsstr (const wchar_t *__restrict, const wchar_t *__restrict);
		virtual wchar_t *wcswcs (const wchar_t *, const wchar_t *);

		virtual wchar_t *wmemchr (const wchar_t *, wchar_t, size_t);
		virtual int wmemcmp (const wchar_t *, const wchar_t *, size_t);
		virtual wchar_t *wmemcpy (wchar_t *__restrict, const wchar_t *__restrict, size_t);
		virtual wchar_t *wmemmove (wchar_t *, const wchar_t *, size_t);
		virtual wchar_t *wmemset (wchar_t *, wchar_t, size_t);

		virtual wint_t btowc (int);
		virtual int wctob (wint_t);

		virtual int mbsinit (const mbstate_t *);
		virtual size_t mbrtowc (wchar_t *__restrict, const char *__restrict, size_t, mbstate_t *__restrict);
		virtual size_t wcrtomb (char *__restrict, wchar_t, mbstate_t *__restrict);

		virtual size_t mbrlen (const char *__restrict, size_t, mbstate_t *__restrict);

		virtual size_t mbsrtowcs (wchar_t *__restrict, const char **__restrict, size_t, mbstate_t *__restrict);
		virtual size_t wcsrtombs (char *__restrict, const wchar_t **__restrict, size_t, mbstate_t *__restrict);

		virtual float wcstof (const wchar_t *__restrict, wchar_t **__restrict);
		virtual double wcstod (const wchar_t *__restrict, wchar_t **__restrict);
		virtual long double wcstold (const wchar_t *__restrict, wchar_t **__restrict);

		virtual long wcstol (const wchar_t *__restrict, wchar_t **__restrict, int);
		virtual unsigned long wcstoul (const wchar_t *__restrict, wchar_t **__restrict, int);

		virtual long long wcstoll (const wchar_t *__restrict, wchar_t **__restrict, int);
		virtual unsigned long long wcstoull (const wchar_t *__restrict, wchar_t **__restrict, int);

		virtual int fwide (FILE *, int);


		virtual int wprintf (const wchar_t *__restrict, ...);
		virtual int fwprintf (FILE *__restrict, const wchar_t *__restrict, ...);
		virtual int swprintf (wchar_t *__restrict, size_t, const wchar_t *__restrict, ...);

		virtual int vwprintf (const wchar_t *__restrict, __isoc_va_list);
		virtual int vfwprintf (FILE *__restrict, const wchar_t *__restrict, __isoc_va_list);
		virtual int vswprintf (wchar_t *__restrict, size_t, const wchar_t *__restrict, __isoc_va_list);

		virtual int wscanf (const wchar_t *__restrict, ...);
		virtual int fwscanf (FILE *__restrict, const wchar_t *__restrict, ...);
		virtual int swscanf (const wchar_t *__restrict, const wchar_t *__restrict, ...);

		virtual int vwscanf (const wchar_t *__restrict, __isoc_va_list);
		virtual int vfwscanf (FILE *__restrict, const wchar_t *__restrict, __isoc_va_list);
		virtual int vswscanf (const wchar_t *__restrict, const wchar_t *__restrict, __isoc_va_list);

		virtual wint_t fgetwc (FILE *);
		virtual wint_t getwc (FILE *);
		virtual wint_t getwchar (void);

		virtual wint_t fputwc (wchar_t, FILE *);
		virtual wint_t putwc (wchar_t, FILE *);
		virtual wint_t putwchar (wchar_t);

		virtual wchar_t *fgetws (wchar_t *__restrict, int, FILE *__restrict);
		virtual int fputws (const wchar_t *__restrict, FILE *__restrict);

		virtual wint_t ungetwc (wint_t, FILE *);

		virtual size_t wcsftime (wchar_t *__restrict, size_t, const wchar_t *__restrict, const struct tm *__restrict);

#if defined(_POSIX_SOURCE) || defined(_POSIX_C_SOURCE) || defined(_XOPEN_SOURCE) || defined(_GNU_SOURCE)  || defined(_BSD_SOURCE)
		virtual FILE *open_wmemstream(wchar_t **, size_t *);
		virtual size_t mbsnrtowcs(wchar_t *__restrict, const char **__restrict, size_t, size_t, mbstate_t *__restrict);
		virtual size_t wcsnrtombs(char *__restrict, const wchar_t **__restrict, size_t, size_t, mbstate_t *__restrict);
		virtual wchar_t *wcsdup(const wchar_t *);
		virtual size_t wcsnlen (const wchar_t *, size_t);
		virtual wchar_t *wcpcpy (wchar_t *__restrict, const wchar_t *__restrict);
		virtual wchar_t *wcpncpy (wchar_t *__restrict, const wchar_t *__restrict, size_t);
		virtual int wcscasecmp(const wchar_t *, const wchar_t *);
		virtual int wcscasecmp_l(const wchar_t *, const wchar_t *, locale_t);
		virtual int wcsncasecmp(const wchar_t *, const wchar_t *, size_t);
		virtual int wcsncasecmp_l(const wchar_t *, const wchar_t *, size_t, locale_t);
		virtual int wcscoll_l(const wchar_t *, const wchar_t *, locale_t);
		virtual size_t wcsxfrm_l(wchar_t *__restrict, const wchar_t *__restrict, size_t n, locale_t);
#endif
        ...
        virtual int _wstat64( const wchar_t* pName, stat64* pStat );
