...
/*
	...
	{
		return OutputW( format, 0, false, false, argptr );
	}

	//--------------------------------------------------------------------------------
	int __cdecl _woutput_l ( const wchar_t* format, CLocaleThreadData* plocinfo, va_list argptr )
	{
		return OutputW( format, plocinfo, false, false, argptr );
	}

	//--------------------------------------------------------------------------------
	int __cdecl _woutput_p ( const wchar_t* format, va_list argptr )
	{
		return OutputW( format, 0, false, true, argptr );
	}

	//--------------------------------------------------------------------------------
	int __cdecl _woutput_p_l ( const wchar_t* format, CLocaleThreadData* plocinfo, va_list argptr )
	{
		return OutputW( format, plocinfo, false, true, argptr );
	}

	//--------------------------------------------------------------------------------
	int __cdecl _woutput_s ( const wchar_t* format, va_list argptr )
	{
		return OutputW( format, 0, true, false, argptr );
	}

	//--------------------------------------------------------------------------------
	int __cdecl _woutput_s_l ( const wchar_t* format, CLocaleThreadData* plocinfo, va_list argptr )
	{
		return OutputW( format, plocinfo, true, false, argptr );
	}

	//--------------------------------------------------------------------------------
	int __cdecl _output( const char* format, va_list argptr )
	{
		return OutputA( format, 0, false, false, argptr );
	}
	
	//--------------------------------------------------------------------------------
	int __cdecl _output_l ( const char* format, CLocaleThreadData* plocinfo, va_list argptr )
	{
		return OutputA( format, plocinfo, false, false, argptr );
	}
	
	//--------------------------------------------------------------------------------
	int __cdecl _output_p ( const char* format, va_list argptr )
	{
		return OutputA( format, 0, false, true, argptr );
	}

	//--------------------------------------------------------------------------------
	int __cdecl _output_p_l ( const char* format, CLocaleThreadData* plocinfo, va_list argptr )
	{
		return OutputA( format, plocinfo, false, true, argptr );
	}

	//--------------------------------------------------------------------------------
	int __cdecl _output_s ( const char* format, va_list argptr )
	{
		return OutputA( format, 0, true, false, argptr );
	}

	//--------------------------------------------------------------------------------
	int __cdecl _output_s_l ( const char* format, CLocaleThreadData* plocinfo, va_list argptr )
	{
		return OutputA( format, plocinfo, true, false, argptr );
	}

	//--------------------------------------------------------------------------------
	int OutputA( const char* format, CLocaleThreadData* plocinfo, bool bSecure, bool bPositionalParams, va_list argptr )
	{
	}
*/

	//--------------------------------------------------------------------------------
	void CFormatter::OutputA_State_ST_FLAG()
	{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputW_State_ST_FLAG()
	{
		// set flag based on which flag character
		switch( chW )
		{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::Output_State_ST_PERCENT()
	{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputA_p_State_ST_NORMAL_2()
	{
		write_charA( chA, m_pFile,  &charsout );
	}

	//--------------------------------------------------------------------------------
	void CFormatter::OutputW_p_State_ST_NORMAL_2()
	{
		// normal state -- just write character
		bufferiswide = 1;
		write_charW( chW, m_pFile, &charsout );
	}

	//--------------------------------------------------------------------------------
	bool CFormatter::Output_p_State_ST_NORMAL_1()
	{
		bool bResult = false;
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputA_p_State_ST_WIDTH( const char* format, va_list& argptr )
	{
		// update width value
		if( chA == '*' )
		{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputW_p_State_ST_WIDTH( const wchar_t* format, va_list& argptr )
	{
		// update width value
		if( chW == L'*' )
		{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputA_p_State_ST_PRECIS( const char* format, va_list argptr )
	{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputW_p_State_ST_PRECIS( const wchar_t* format, va_list argptr )
	{
		// update precison value
		if( chW == L'*' )
		{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputA_p_State_ST_SIZE( const char* format )
	{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputW_p_State_ST_SIZE( const wchar_t* format )
	{
		// just read a size specifier, set the flags based on it
		switch( chW )
		{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::Output_State_ST_TYPE_C()
	{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputA_p_l_State_ST_TYPE_c( /*nsWin32::CLocaleUpdate& _loc_update,*/ va_list argptr )
	{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputW_p_l_State_ST_TYPE_c( /*nsWin32::CLocaleUpdate& _loc_update,*/ va_list argptr )
	{
		// print a single character specified by int argument
		bufferiswide = 1;
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputA_p_State_ST_TYPE_Z( va_list& argptr )
	{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputW_p_State_ST_TYPE_Z( va_list& argptr )
	{
		// print a Counted String
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputA_p_l_State_ST_TYPE_s( /*nsWin32::CLocaleUpdate& _loc_update,*/ va_list& argptr )
	{
		// print a string --
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputW_p_l_State_ST_TYPE_s( /*nsWin32::CLocaleUpdate& _loc_update,*/ va_list& argptr )
	{
		// print a string --
		// ANSI rules on how much of string to print:
		//   all if precision is default,
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputA_p_l_State_ST_TYPE_n( va_list& argptr )
	{
...
//		}
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputW_p_l_State_ST_TYPE_n( va_list& argptr )
	{
...
//		}
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputA_p_l_State_ST_TYPE_a( /*nsWin32::CLocaleUpdate& _loc_update,*/ va_list& argptr )
	{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputW_p_l_State_ST_TYPE_a( /*nsWin32::CLocaleUpdate& _loc_update,*/ va_list& argptr )
	{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputA_p_l_State_ST_TYPE_COMMON_INT( va_list& argptr )
	{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputW_p_l_State_ST_TYPE_COMMON_INT( va_list& argptr )
	{
		// This is the general integer formatting routine.
		// Basically, we get an argument, make it positive
		// if necessary, and convert it according to the
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputA_p_l_State_ST_TYPE( /*nsWin32::CLocaleUpdate& _loc_update,*/ va_list& argptr )
	{
...
//			COMMON_INT:
		...
		if( !no_output )
		{
			...
			if( !( flags & ( FL_LEFT | FL_LEADZERO ) ) )
			{
				...
				write_multi_charA( ' ', padding, m_pFile, &charsout );
			}

			// write prefix
			write_stringA( prefixA, prefixlen, m_pFile, &charsout );

			if( ( flags & FL_LEADZERO ) && !( flags & FL_LEFT ) )
			{
				// write leading zeros
				write_multi_charA( '0', padding, m_pFile, &charsout );
			}

			// write text
			write_stringA( text.sz, textlen, m_pFile, &charsout );
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputW_p_l_State_ST_TYPE( /*nsWin32::CLocaleUpdate& _loc_update,*/ va_list& argptr )
	{
		...
		if( !no_output )
		{
			...
			{
				// pad on left with blanks
				write_multi_charW( L' ', padding, m_pFile, &charsout );
			}

			// write prefix
			write_stringW( prefixW, prefixlen, m_pFile, &charsout );

			if( ( flags & FL_LEADZERO ) && !( flags & FL_LEFT ) )
			{
				// write leading zeros
				write_multi_charW( L'0', padding, m_pFile, &charsout );
			}
			...
			if( !bufferiswide && textlen > 0 )
			{
				...
				while( count-- > 0 )
				{
					...
					write_charW( wchar, m_pFile, &charsout );
					p += retval;
				}
			}
			else
			{
				write_stringW( text.wz, textlen, m_pFile, &charsout );
			}
	...
	//--------------------------------------------------------------------------------
	int CFormatter::OutputA_l_State( /*nsWin32::CLocaleUpdate& _loc_update,*/ const char* format/*, CLocaleThreadData* plocinfo*/, bool bSecure, bool bPositionalParams, va_list& argptr )
	{
		int iResult = 0;
	...
	//--------------------------------------------------------------------------------
	int CFormatter::OutputW_p_l_State( /*nsWin32::CLocaleUpdate& _loc_update,*/ const wchar_t* format/*, CLocaleThreadData* plocinfo*/, bool bSecure, bool bPositionalParams, va_list& argptr )
	{
		int iResult = 0;
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputA_l_Main( /*nsWin32::CLocaleUpdate& _loc_update,*/ const char* format/*, CLocaleThreadData* plocinfo*/, va_list argptr )
	{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::OutputW_l_Main( /*nsWin32::CLocaleUpdate& _loc_update,*/ const wchar_t* format/*, CLocaleThreadData* plocinfo*/, va_list argptr )
	{
		// main loop -- loop while format character exist and no I/O errors
	...
	//--------------------------------------------------------------------------------
	void CFormatter::Output_Positonal( va_list argptr )
	{
	...
	//--------------------------------------------------------------------------------
	int CFormatter::OutputA_l( const char* format/*, CLocaleThreadData* plocinfo*/, va_list argptr )
	{
	...
	//--------------------------------------------------------------------------------
	int CFormatter::OutputW_l( const wchar_t* format/*, CLocaleThreadData* plocinfo*/, va_list argptr )
	{
		//nsWin32::CLocaleUpdate _loc_update( plocinfo );
	...
	//--------------------------------------------------------------------------------
	void CFormatter::cfltcvt( double value, char* buffer, char fmt, int precision, int capexp )
	{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::forcdecpt( char* buffer )
	{
		while( *buffer )
		{
			if( *buffer == '.' )
	...
	//--------------------------------------------------------------------------------
	void CFormatter::cropzeros( char* buffer )
	{
		char* stop;
	...
	//--------------------------------------------------------------------------------
	char* CFormatter::cvt( double arg, int ndigits, int* decpt, int* sign, char* buf, int eflag )
	{
		int r2;
		double fi, fj;
		char* p, *p1;
	...
	//--------------------------------------------------------------------------------
	char* CFormatter::ecvt( double arg, int ndigits, int* decpt, int* sign )
	{
		return cvt( arg, ndigits, decpt, sign, t_pCurrentWin32Thread->Data().CVTBuffer(), 1 );
	}

	//--------------------------------------------------------------------------------
	char* CFormatter::ecvtbuf( double arg, int ndigits, int* decpt, int* sign, char* buf )
	{
		return cvt( arg, ndigits, decpt, sign, buf, 1 );
	}

	//--------------------------------------------------------------------------------
	char* CFormatter::fcvt( double arg, int ndigits, int* decpt, int* sign )
	{
		return cvt( arg, ndigits, decpt, sign, t_pCurrentWin32Thread->Data().CVTBuffer(), 0 );
	}

	//--------------------------------------------------------------------------------
	char* CFormatter::fcvtbuf( double arg, int ndigits, int* decpt, int* sign, char* buf )
	{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::write_charA( char ch, int* pnumwritten )
	{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::write_charW( wchar_t ch, int* pnumwritten )
	{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::write_charA( char ch, CCRTFile* pFile, int* pnumwritten )
	{

		if( ( pFile->_flag & _IOSTRG ) && pFile->_base == 0 )
		{
			++(*pnumwritten);
			return;
		}

		if( pFile->PutCUnlocked( ch ) == -1/*EOF*/ )
		{
			*pnumwritten = -1;
		}
		else
	...
	//--------------------------------------------------------------------------------
	void CFormatter::write_charW( wchar_t ch, CCRTFile* f, int* pnumwritten )
	{
		if( ( f->_flag & _IOSTRG ) && f->_base == 0 )
		{
			++(*pnumwritten);
			return;
		}

		if( m_pFile->PutCNoLockW( ch ) == WEOF )
		{
			*pnumwritten = -1;
		}
		else
	...
	//--------------------------------------------------------------------------------
	void CFormatter::write_multi_charA( char ch, int num, int* pnumwritten )
	{
		while( num-- > 0 )
		{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::write_multi_charW( wchar_t ch, int num, int* pnumwritten )
	{
		while( num-- > 0 )
		{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::write_multi_charA( char ch, int num, CCRTFile *f, int *pnumwritten )
	{
		while( num-- > 0 )
		{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::write_multi_charW( wchar_t ch, int num, CCRTFile *f, int *pnumwritten )
	{
		while( num-- > 0 )
		{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::write_stringA( char* string, int len, int* pnumwritten )
	{
		while( len-- > 0 )
		{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::write_stringW( wchar_t* string, int len, int* pnumwritten )
	{
		while( len-- > 0 )
		{
	...
	//--------------------------------------------------------------------------------
	void CFormatter::write_stringA( char* string, int len, CCRTFile* f, int* pnumwritten )
	{
		if( ( f->_flag & _IOSTRG ) && f->_base == 0 )
		{
			(*pnumwritten) += len;
	...
	//--------------------------------------------------------------------------------
	void CFormatter::write_stringW ( wchar_t* string, int len, CCRTFile* f, int* pnumwritten )
	{
		if( ( f->_flag & _IOSTRG ) && f->_base == 0 )
		{
			(*pnumwritten) += len;
	...
	//--------------------------------------------------------------------------------
	//int CFormatter::_mbtowc_l( wchar_t* pwc, const char* s, size_t n, CLocaleThreadData* plocinfo )
	//{
	//	if( !s || n == 0 )
	//	{
	...
	//--------------------------------------------------------------------------------
	wint_t CFormatter::_putwch_nolock ( wchar_t ch )
	{
		/*
	...
	//--------------------------------------------------------------------------------
	int CFormatter::_putch_nolock( int c )
	{
