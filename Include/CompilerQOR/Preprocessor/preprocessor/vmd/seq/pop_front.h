...
#if !defined(QOR_VMD_SEQ_POP_FRONT_H)
#define QOR_VMD_SEQ_POP_FRONT_H
...
#include "CompilerQOR/Preprocessor/preprocessor/seq/pop_front.h"
...
#define QOR_VMD_SEQ_POP_FRONT(seq) \
    QOR_PP_IIF \
        ( \
        QOR_PP_EQUAL(QOR_PP_SEQ_SIZE(seq),1), \
        QOR_VMD_EMPTY, \
        QOR_PP_SEQ_POP_FRONT \
        ) \
    (seq) \
/**/

#endif /* QOR_PP_VARIADICS */
#endif /* QOR_VMD_SEQ_POP_FRONT_H */
